...
2) Выберите вашу модель из выпадающего списка
3) Выберите тип модели (`SD` или `SDXL`)
4) Настройте модель по нужным вам параметрам
5) Введите ваш запрос
6) Нажмите кнопку `submit`, чтобы получить сгенерированное изображение
#### Необязательно: вы можете выбрать свою модель `vae` и включить `upscale`, чтобы увеличить размер сгенерированного изображения
...
* TTS и Whisper модели скачиваються автоматически в папку *inputs* при их использовании
