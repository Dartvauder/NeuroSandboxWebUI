...
* На данный момент доступно только простое масштабирование любого из ваших изображений
...
4) Вы также можете выключить и перезапустить приложение с помощью кнопок `Close terminal` и `ReloadUI` 
#### Чтобы полностью выключить приложение, просто закройте терминал
