...
#### Необязательно: вы можете выбрать свои модели `vae` и `lora`, а так-же включить `upscale` чтобы увеличить размер сгенерированного изображения
...
3) Нажмите кнопку «Отправить», чтобы получить измененное изображение
