...
#### Интерфейс имеет две вкладки: LLM и Stable Diffusion. Выберите тот, который вам нужен и следуйте инструкциям
...
2) Включите `Stable Diffusion`
3) Выберите модель из выпадающего списка 
4) Настройте модель по нужным вам параметрам
5) Впишите ваш промпт
