...
2) Выберите вашу модель в раскрывающемся списке
...
#### Необязательно: вы можете выбрать модель `Vae` и включить `upscale`, чтобы увеличить размер создаваемого изображения.
...
2) Выберите вашу модель в раскрывающемся списке
3) Настройте модель по нужным вам параметрам
4) Загрузите исходное изображение, с которым будет происходить генерация
5) Введите ваш запрос
6) Нажмите кнопку `submit`, чтобы получить изображение
#### Необязательно: вы можете выбрать модель вашего `vae`
#### vae = *inputs/image/sd_models/vae*

### AudioCraft:

1) Выберите модель в раскрывающемся списке
2) Настройте модель по нужным вам параметрам
3) Введите ваш запрос
4) (Необязательно) загрузите исходный звук, если вы используете модель melody
5) Нажмите кнопку `submit`, чтобы получить аудио
#### Необязательно: вы можете включить `multiband diffusion` для улучшения генерируемого звука
...
* Модели Stable Diffusion и vae можно взять с сайта [CivitAI](https://civitai.com/models)
