...
1) `Git clone` или [скачайте](https://github.com/Dartvauder/NeuroChatWebUI/files/14622965/NeuroChatWebUI.zip) репозиторий.
...
#### История чата сохраняются в папке outputs
