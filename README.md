...
### Image: <img width="1115" alt="2" src="https://github.com/user-attachments/assets/5c627fd9-9475-4894-b14e-0050e59b49fe">
...
* Supports Lora, Textual inversion (embedding), Vae, MagicPrompt, Img2img, Depth, Pix2Pix, Controlnet, Upscalers (latent and SUPIR), Refiner, Inpaint, Outpaint, GLIGEN, AnimateDiff, HotShot-XL, Videos, LDM3D, SD3, Cascade, T2I-IP-ADAPTER, IP-Adapter-FaceID and Riffusion models (For StableDiffusion)
