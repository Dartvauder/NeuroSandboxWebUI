...
iface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Dropdown(choices=llm_models_list, label="Выберите языковую модель", value=None),
        ...
        gr.Checkbox(label="Включить стабильную диффузию", value=False),
        gr.Dropdown(choices=stable_diffusion_models_list, label="Выберите модель стабильной диффузии", interactive=True),
