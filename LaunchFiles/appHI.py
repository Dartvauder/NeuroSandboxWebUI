...
sd3_interface = gr.Interface(
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको किसी भी पाठ को दर्ज करने और Stable Diffusion 3 का उपयोग करके छवियाँ उत्पन्न करने की अनुमति देता है। आप स्लाइडर्स से जनरेशन सेटिंग्स को अनुकूलित कर सकते हैं। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
