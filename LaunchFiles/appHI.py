...
chat_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="अपना अनुरोध दर्ज करें"),
        gr.Audio(type="filepath", label="अपना अनुरोध रिकॉर्ड करें (वैकल्पिक)"),
        gr.Image(label="अपनी छवि अपलोड करें (वैकल्पिक)", type="filepath"),
        gr.Dropdown(choices=llm_models_list, label="LLM मॉडल चुनें", value=None),
        gr.Dropdown(choices=llm_lora_models_list, label="LoRA मॉडल चुनें (वैकल्पिक)", value=None),
        gr.HTML("<h3>LLM सेटिंग्स</h3>"),
        gr.Radio(choices=["transformers", "llama"], label="मॉडल प्रकार चुनें", value="transformers"),
        gr.Slider(minimum=1, maximum=4096, value=512, step=1, label="अधिकतम लंबाई (transformers प्रकार के मॉडल के लिए)"),
        gr.Slider(minimum=1, maximum=4096, value=512, step=1, label="अधिकतम टोकन (llama प्रकार के मॉडल के लिए)"),
        gr.Slider(minimum=0.0, maximum=2.0, value=0.7, step=0.1, label="तापमान"),
        gr.Slider(minimum=0.0, maximum=1.0, value=0.9, step=0.1, label="शीर्ष P"),
        gr.Slider(minimum=0, maximum=100, value=20, step=1, label="शीर्ष K"),
        gr.Radio(choices=["txt", "json"], label="चैट इतिहास प्रारूप चुनें", value="txt", interactive=True),
        gr.Checkbox(label="वेब खोज सक्षम करें", value=False),
        gr.Checkbox(label="LibreTranslate सक्षम करें", value=False),
        gr.Dropdown(choices=["en", "es", "fr", "de", "it", "pt", "pl", "tr", "ru", "nl", "cs", "ar", "zh", "ja", "hi"], label="लक्षित भाषा चुनें", value="ru", interactive=True),
        gr.Checkbox(label="मल्टीमोडल सक्षम करें", value=False),
        gr.Checkbox(label="TTS सक्षम करें", value=False),
        gr.HTML("<h3>TTS सेटिंग्स</h3>"),
        gr.Dropdown(choices=speaker_wavs_list, label="आवाज़ चुनें", interactive=True),
        gr.Dropdown(choices=["en", "ru"], label="भाषा चुनें", interactive=True),
        gr.Slider(minimum=0.0, maximum=1.9, value=1.0, step=0.1, label="TTS तापमान", interactive=True),
        gr.Slider(minimum=0.0, maximum=1.0, value=0.9, step=0.1, label="TTS शीर्ष P", interactive=True),
        gr.Slider(minimum=0, maximum=100, value=20, step=1, label="TTS शीर्ष K", interactive=True),
        gr.Slider(minimum=0.5, maximum=2.0, value=1.0, step=0.1, label="TTS गति", interactive=True),
        gr.Radio(choices=["wav", "mp3", "ogg"], label="आउटपुट प्रारूप चुनें", value="wav", interactive=True),
        gr.Button(value="जनरेशन रोकें", interactive=True, variant="stop"),
    ],
    outputs=[
        gr.Chatbot(label="LLM पाठ प्रतिक्रिया", value=[]),
        gr.Audio(label="LLM ऑडियो प्रतिक्रिया", type="filepath"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - LLM",
    description="यह उपयोगकर्ता इंटरफ़ेस आपको किसी भी पाठ या ऑडियो को दर्ज करने और उत्पन्न प्रतिक्रिया प्राप्त करने की अनुमति देता है। आप ड्रॉपडाउन सूचियों से LLM मॉडल, अवतार, आवाज और tts के लिए भाषा चुन सकते हैं। आप स्लाइडर्स से मॉडल सेटिंग्स को भी अनुकूलित कर सकते हैं। इसे आजमाएं और देखें क्या होता है!",
...
tts_stt_interface = gr.Interface(
    fn=generate_tts_stt,
    inputs=[
        gr.Textbox(label="TTS के लिए पाठ दर्ज करें"),
        gr.Audio(label="STT के लिए ऑडियो रिकॉर्ड करें", type="filepath"),
        gr.HTML("<h3>TTS सेटिंग्स</h3>"),
        gr.Dropdown(choices=speaker_wavs_list, label="आवाज़ चुनें", interactive=True),
        gr.Dropdown(choices=["en", "es", "fr", "de", "it", "pt", "pl", "tr", "ru", "nl", "cs", "ar", "zh-cn", "ja", "hu", "ko", "hi"], label="भाषा चुनें", interactive=True),
        gr.Slider(minimum=0.0, maximum=1.9, value=1.0, step=0.1, label="TTS तापमान", interactive=True),
        gr.Slider(minimum=0.0, maximum=1.0, value=0.9, step=0.1, label="TTS शीर्ष P", interactive=True),
        gr.Slider(minimum=0, maximum=100, value=20, step=1, label="TTS शीर्ष K", interactive=True),
        gr.Slider(minimum=0.5, maximum=2.0, value=1.0, step=0.1, label="TTS गति", interactive=True),
        gr.Radio(choices=["wav", "mp3", "ogg"], label="TTS आउटपुट प्रारूप चुनें", value="wav", interactive=True),
        gr.Dropdown(choices=["txt", "json"], label="STT आउटपुट प्रारूप चुनें", value="txt", interactive=True),
    ],
    outputs=[
        gr.Audio(label="TTS ऑडियो", type="filepath"),
        gr.Textbox(label="STT पाठ"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - TTS-STT",
    description="यह उपयोगकर्ता इंटरफ़ेस आपको टेक्स्ट-टू-स्पीच (CoquiTTS) के लिए पाठ दर्ज करने और स्पीच-टू-टेक्स्ट (OpenAIWhisper) के लिए ऑडियो रिकॉर्ड करने की अनुमति देता है। TTS के लिए, आप आवाज और भाषा चुन सकते हैं, और स्लाइडर्स से जनरेशन सेटिंग्स को अनुकूलित कर सकते हैं। STT के लिए, बस अपना ऑडियो रिकॉर्ड करें और बोला गया पाठ प्रदर्शित हो जाएगा। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
bark_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="अनुरोध के लिए पाठ दर्ज करें"),
        gr.Dropdown(choices=[None, "v2/en_speaker_1", "v2/ru_speaker_1", "v2/de_speaker_1", "v2/fr_speaker_1", "v2/es_speaker_1", "v2/hi_speaker_1", "v2/it_speaker_1", "v2/ja_speaker_1", "v2/ko_speaker_1", "v2/pt_speaker_1", "v2/zh_speaker_1", "v2/tr_speaker_1", "v2/pl_speaker_1"], label="आवाज प्रीसेट चुनें", value=None),
        gr.Slider(minimum=1, maximum=1000, value=100, step=1, label="अधिकतम लंबाई"),
        gr.Slider(minimum=0.1, maximum=2.0, value=0.4, step=0.1, label="सूक्ष्म तापमान"),
        gr.Slider(minimum=0.1, maximum=2.0, value=0.8, step=0.1, label="मोटा तापमान"),
        gr.Radio(choices=["wav", "mp3", "ogg"], label="आउटपुट प्रारूप चुनें", value="wav", interactive=True),
        gr.Button(value="जनरेशन रोकें", interactive=True, variant="stop"),
    ],
    outputs=[
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको पाठ दर्ज करने और SunoBark का उपयोग करके ऑडियो उत्पन्न करने की अनुमति देता है। आप आवाज प्रीसेट चुन सकते हैं और अधिकतम लंबाई को अनुकूलित कर सकते हैं। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
translate_interface = gr.Interface(
    fn=translate_text,
    inputs=[
        gr.Textbox(label="अनुवाद करने के लिए पाठ दर्ज करें"),
        gr.Dropdown(choices=["en", "es", "fr", "de", "it", "pt", "pl", "tr", "ru", "nl", "cs", "ar", "zh", "ja", "hi"], label="स्रोत भाषा चुनें", value="en"),
        gr.Dropdown(choices=["en", "es", "fr", "de", "it", "pt", "pl", "tr", "ru", "nl", "cs", "ar", "zh", "ja", "hi"], label="लक्षित भाषा चुनें", value="ru"),
        gr.Checkbox(label="अनुवाद इतिहास सहेजना सक्षम करें", value=False),
        gr.Radio(choices=["txt", "json"], label="अनुवाद इतिहास प्रारूप चुनें", value="txt", interactive=True),
        gr.File(label="पाठ फ़ाइल अपलोड करें (वैकल्पिक)", file_count="single", interactive=True),
    ],
    outputs=[
        gr.Textbox(label="अनुवादित पाठ"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - LibreTranslate",
    description="यह उपयोगकर्ता इंटरफ़ेस आपको पाठ दर्ज करने और LibreTranslate का उपयोग करके इसका अनुवाद करने की अनुमति देता है। स्रोत और लक्षित भाषाएँ चुनें और अनुवाद प्राप्त करने के लिए सबमिट करें। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
wav2lip_interface = gr.Interface(
    fn=generate_wav2lip,
    inputs=[
        gr.Image(label="इनपुट छवि", type="filepath"),
        gr.Audio(label="इनपुट ऑडियो", type="filepath"),
        gr.Slider(minimum=1, maximum=60, value=30, step=1, label="FPS"),
        gr.Textbox(label="पैड्स", value="0 10 0 0"),
        gr.Slider(minimum=1, maximum=64, value=16, step=1, label="चेहरा पहचान बैच आकार"),
        gr.Slider(minimum=1, maximum=512, value=128, step=1, label="Wav2Lip बैच आकार"),
        gr.Slider(minimum=1, maximum=4, value=1, step=1, label="आकार बदलने का कारक"),
        gr.Textbox(label="क्रॉप", value="0 -1 0 -1"),
    ],
    outputs=[
        gr.Video(label="उत्पन्न लिप-सिंक"),
        gr.Textbox(label="संदेश", type="text"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - Wav2Lip",
    description="यह उपयोगकर्ता इंटरफ़ेस आपको Wav2Lip का उपयोग करके एक छवि और एक ऑडियो फ़ाइल को जोड़कर बोलने वाले सिर वीडियो उत्पन्न करने की अनुमति देता है। एक छवि और एक ऑडियो फ़ाइल अपलोड करें, और बोलने वाले सिर वीडियो बनाने के लिए जनरेट पर क्लिक करें। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
txt2img_interface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Dropdown(choices=vae_models_list, label="VAE मॉडल चुनें (वैकल्पिक)", value=None),
        gr.Dropdown(choices=lora_models_list, label="LORA मॉडल चुनें (वैकल्पिक)", value=None, multiselect=True),
        gr.Dropdown(choices=textual_inversion_models_list, label="एम्बेडिंग मॉडल चुनें (वैकल्पिक)", value=None, multiselect=True),
        gr.HTML("<h3>StableDiffusion सेटिंग्स</h3>"),
        gr.Radio(choices=["SD", "SD2", "SDXL"], label="मॉडल प्रकार चुनें", value="SD"),
        gr.Dropdown(choices=["euler_ancestral", "euler", "lms", "heun", "dpm", "dpm_solver", "dpm_solver++"],
                    label="सैंपलर चुनें", value="euler_ancestral"),
        ...
        gr.Slider(minimum=1, maximum=4, value=1, step=1, label="क्लिप स्किप"),
        gr.Checkbox(label="FreeU सक्षम करें", value=False),
        gr.Checkbox(label="टाइल्ड VAE सक्षम करें", value=False),
        gr.Checkbox(label="अपस्केल सक्षम करें", value=False),
        gr.Radio(choices=["x2", "x4"], label="अपस्केल आकार", value="x2"),
        gr.Slider(minimum=1, maximum=100, value=50, step=1, label="अपस्केल कदम"),
        gr.Slider(minimum=1.0, maximum=30.0, value=6, step=0.1, label="अपस्केल CFG"),
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको किसी भी पाठ को दर्ज करने और StableDiffusion का उपयोग करके छवियाँ उत्पन्न करने की अनुमति देता है। आप मॉडल चुन सकते हैं और स्लाइडर्स से जनरेशन सेटिंग्स को अनुकूलित कर सकते हैं। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
img2img_interface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Slider(minimum=0.0, maximum=1.0, value=0.5, step=0.01, label="शक्ति"),
        gr.Dropdown(choices=stable_diffusion_models_list, label="StableDiffusion मॉडल चुनें", value=None),
        gr.Dropdown(choices=vae_models_list, label="VAE मॉडल चुनें (वैकल्पिक)", value=None),
        gr.HTML("<h3>StableDiffusion सेटिंग्स</h3>"),
        gr.Radio(choices=["SD", "SD2", "SDXL"], label="मॉडल प्रकार चुनें", value="SD"),
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको किसी भी पाठ और छवि को दर्ज करने और StableDiffusion का उपयोग करके नई छवियाँ उत्पन्न करने की अनुमति देता है। आप मॉडल चुन सकते हैं और स्लाइडर्स से जनरेशन सेटिंग्स को अनुकूलित कर सकते हैं। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
depth2img_interface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Image(label="प्रारंभिक छवि", type="filepath"),
        gr.HTML("<h3>StableDiffusion सेटिंग्स</h3>"),
        gr.Slider(minimum=0.0, maximum=1.0, value=0.7, step=0.01, label="शक्ति"),
        gr.Radio(choices=["png", "jpeg"], label="आउटपुट प्रारूप चुनें", value="png", interactive=True),
        gr.Button(value="जनरेशन रोकें", interactive=True, variant="stop"),
    ],
    outputs=[
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको एक प्रॉम्प्ट, एक प्रारंभिक छवि दर्ज करने और StableDiffusion का उपयोग करके गहराई-जागरूक छवियाँ उत्पन्न करने की अनुमति देता है। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
pix2pix_interface = gr.Interface(
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको एक प्रॉम्प्ट और एक प्रारंभिक छवि दर्ज करने और Pix2Pix का उपयोग करके नई छवियाँ उत्पन्न करने की अनुमति देता है। आप स्लाइडर्स से जनरेशन सेटिंग्स को अनुकूलित कर सकते हैं। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
controlnet_interface = gr.Interface(
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको ControlNet मॉडल का उपयोग करके छवियाँ उत्पन्न करने की अनुमति देता है। एक प्रारंभिक छवि अपलोड करें, एक प्रॉम्प्ट दर्ज करें, एक Stable Diffusion मॉडल चुनें, और जनरेशन सेटिंग्स को अनुकूलित करें। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
latent_upscale_interface = gr.Interface(
    ...
    inputs=[
        gr.Image(label="अपस्केल करने के लिए छवि", type="filepath"),
        gr.Slider(minimum=1, maximum=100, value=50, step=1, label="कदम"),
        gr.Slider(minimum=1.0, maximum=30.0, value=8, step=0.1, label="CFG"),
        gr.Radio(choices=["png", "jpeg"], label="आउटपुट प्रारूप चुनें", value="png", interactive=True),
        gr.Button(value="जनरेशन रोकें", interactive=True, variant="stop"),
    ],
    outputs=[
        gr.Image(type="filepath", label="अपस्केल की गई छवि"),
        gr.Textbox(label="संदेश", type="text"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - StableDiffusion (upscale-latent)",
    description="यह उपयोगकर्ता इंटरफ़ेस आपको एक छवि अपलोड करने और इसे लेटेंट अपस्केल करने की अनुमति देता है",
    allow_flagging="never",
)
...
realesrgan_upscale_interface = gr.Interface(
    ...
    inputs=[
        gr.Image(label="अपस्केल करने के लिए छवि", type="filepath"),
        gr.Slider(minimum=0.1, maximum=8, value=4, step=0.1, label="अपस्केल फैक्टर"),
        gr.Radio(choices=["png", "jpeg"], label="आउटपुट प्रारूप चुनें", value="png", interactive=True),
        gr.Button(value="जनरेशन रोकें", interactive=True, variant="stop"),
    ],
    outputs=[
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको एक छवि अपलोड करने और Real-ESRGAN का उपयोग करके इसे अपस्केल करने की अनुमति देता है",
    allow_flagging="never",
)
...
inpaint_interface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Textbox(label="अपना नकारात्मक प्रॉम्प्ट दर्ज करें", value=""),
        gr.Image(label="प्रारंभिक छवि", type="filepath"),
        gr.ImageEditor(label="मास्क छवि", type="filepath"),
        gr.Slider(minimum=0, maximum=100, value=0, step=1, label="मास्क ब्लर फैक्टर"),
        gr.Dropdown(choices=inpaint_models_list, label="इनपेंट मॉडल चुनें", value=None),
        gr.Dropdown(choices=vae_models_list, label="VAE मॉडल चुनें (वैकल्पिक)", value=None),
        gr.HTML("<h3>StableDiffusion सेटिंग्स</h3>"),
        gr.Radio(choices=["SD", "SD2", "SDXL"], label="मॉडल प्रकार चुनें", value="SD"),
        gr.Dropdown(choices=["euler_ancestral", "euler", "lms", "heun", "dpm", "dpm_solver", "dpm_solver++"],
    ...
    outputs=[
        gr.Image(type="filepath", label="इनपेंटेड छवि"),
        gr.Textbox(label="संदेश", type="text"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - StableDiffusion (inpaint)",
    description="यह उपयोगकर्ता इंटरफ़ेस आपको एक प्रॉम्प्ट, एक प्रारंभिक छवि, और एक मास्क छवि दर्ज करने और StableDiffusion का उपयोग करके इनपेंट करने की अनुमति देता है। आप मॉडल चुन सकते हैं और स्लाइडर्स से जनरेशन सेटिंग्स को अनुकूलित कर सकते हैं। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
gligen_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="अपना प्रॉम्प्ट दर्ज करें"),
        gr.Textbox(label="अपना नकारात्मक प्रॉम्प्ट दर्ज करें", value=""),
        gr.Textbox(label="GLIGEN वाक्यांश दर्ज करें", value=""),
        gr.Textbox(label="GLIGEN बॉक्स दर्ज करें", value=""),
        gr.Dropdown(choices=stable_diffusion_models_list, label="StableDiffusion मॉडल चुनें", value=None),
        gr.HTML("<h3>StableDiffusion सेटिंग्स</h3>"),
        gr.Radio(choices=["SD", "SD2", "SDXL"], label="मॉडल प्रकार चुनें", value="SD"),
        gr.Dropdown(choices=["euler_ancestral", "euler", "lms", "heun", "dpm", "dpm_solver", "dpm_solver++"],
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको Stable Diffusion का उपयोग करके छवियाँ उत्पन्न करने और GLIGEN का उपयोग करके वस्तुओं को सम्मिलित करने की अनुमति देता है। Stable Diffusion मॉडल चुनें, जनरेशन सेटिंग्स को अनुकूलित करें, एक प्रॉम्प्ट, GLIGEN वाक्यांश, और बाउंडिंग बॉक्स दर्ज करें। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
animatediff_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="अपना प्रॉम्प्ट दर्ज करें"),
        gr.Textbox(label="अपना नकारात्मक प्रॉम्प्ट दर्ज करें", value=""),
        gr.Image(label="प्रारंभिक GIF", type="filepath"),
        gr.Slider(minimum=0.0, maximum=1.0, value=0.5, step=0.01, label="शक्ति"),
        gr.Radio(choices=["sd", "sdxl"], label="मॉडल प्रकार चुनें", value="sd"),
        gr.Dropdown(choices=stable_diffusion_models_list, label="StableDiffusion मॉडल चुनें (केवल SD1.5)", value=None),
        gr.Dropdown(choices=[None, "zoom-in", "zoom-out", "tilt-up", "tilt-down", "pan-right", "pan-left"], label="गति LORA चुनें", value=None, multiselect=True),
        gr.Slider(minimum=1, maximum=200, value=20, step=1, label="फ्रेम"),
        gr.Slider(minimum=1, maximum=100, value=30, step=1, label="कदम"),
        gr.Slider(minimum=1.0, maximum=30.0, value=8, step=0.1, label="मार्गदर्शन स्केल"),
    ...
    outputs=[
        gr.Image(label="उत्पन्न GIF", type="filepath"),
        gr.Textbox(label="संदेश", type="text"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - StableDiffusion (animatediff)",
    description="यह उपयोगकर्ता इंटरफ़ेस आपको एक प्रॉम्प्ट दर्ज करने और AnimateDiff का उपयोग करके एनिमेटेड GIF उत्पन्न करने की अनुमति देता है। आप मॉडल चुन सकते हैं और स्लाइडर्स से जनरेशन सेटिंग्स को अनुकूलित कर सकते हैं। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
video_interface = gr.Interface(
    ...
    inputs=[
        gr.Image(label="प्रारंभिक छवि", type="filepath"),
        gr.Radio(choices=["mp4", "gif"], label="आउटपुट प्रारूप चुनें", value="mp4", interactive=True),
        gr.HTML("<h3>SVD सेटिंग्स (mp4)</h3>"),
        gr.Slider(minimum=0, maximum=360, value=180, step=1, label="गति बकेट आईडी"),
        gr.Slider(minimum=0.0, maximum=1.0, value=0.1, step=0.01, label="शोर वृद्धि शक्ति"),
        gr.Slider(minimum=1, maximum=60, value=10, step=1, label="FPS"),
        gr.Slider(minimum=2, maximum=120, value=25, step=1, label="फ्रेम"),
        gr.Slider(minimum=1, maximum=32, value=8, step=1, label="डिकोड चंक आकार"),
        gr.HTML("<h3>I2VGen-xl सेटिंग्स (gif)</h3>"),
        gr.Textbox(label="प्रॉम्प्ट", value=""),
        gr.Textbox(label="नकारात्मक प्रॉम्प्ट", value=""),
        gr.Slider(minimum=1, maximum=100, value=50, step=1, label="कदम"),
        gr.Slider(minimum=1.0, maximum=30.0, value=9.0, step=0.1, label="CFG"),
        gr.Button(value="जनरेशन रोकें", interactive=True, variant="stop"),
    ],
    outputs=[
        gr.Video(label="उत्पन्न वीडियो"),
        gr.Image(label="उत्पन्न GIF", type="filepath"),
        gr.Textbox(label="संदेश", type="text"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - StableDiffusion (video)",
    description="यह उपयोगकर्ता इंटरफ़ेस आपको एक प्रारंभिक छवि दर्ज करने और StableVideoDiffusion (mp4) और I2VGen-xl (gif) का उपयोग करके वीडियो उत्पन्न करने की अनुमति देता है। आप स्लाइडर्स से जनरेशन सेटिंग्स को अनुकूलित कर सकते हैं। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
ldm3d_interface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Slider(minimum=256, maximum=2048, value=512, step=64, label="चौड़ाई"),
        gr.Slider(minimum=256, maximum=2048, value=512, step=64, label="ऊंचाई"),
        gr.Slider(minimum=1, maximum=100, value=40, step=1, label="कदम"),
        gr.Slider(minimum=1.0, maximum=30.0, value=8, step=0.1, label="मार्गदर्शन स्केल"),
        gr.Radio(choices=["png", "jpeg"], label="आउटपुट प्रारूप चुनें", value="png", interactive=True),
        gr.Button(value="जनरेशन रोकें", interactive=True, variant="stop"),
    ],
    outputs=[
        gr.Image(type="filepath", label="उत्पन्न RGB छवि"),
        gr.Image(type="filepath", label="उत्पन्न गहराई छवि"),
        gr.Textbox(label="संदेश", type="text"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - StableDiffusion (LDM3D)",
    description="यह उपयोगकर्ता इंटरफ़ेस आपको एक प्रॉम्प्ट दर्ज करने और LDM3D का उपयोग करके RGB और गहराई छवियाँ उत्पन्न करने की अनुमति देता है। आप स्लाइडर्स से जनरेशन सेटिंग्स को अनुकूलित कर सकते हैं। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
sd3_txt2img_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="अपना प्रॉम्प्ट दर्ज करें"),
        gr.Textbox(label="अपना नकारात्मक प्रॉम्प्ट दर्ज करें", value=""),
        gr.Slider(minimum=1, maximum=100, value=40, step=1, label="चरण"),
        ...
        gr.Slider(minimum=256, maximum=2048, value=1024, step=64, label="ऊंचाई"),
        gr.Slider(minimum=64, maximum=2048, value=256, label="अधिकतम लंबाई"),
        gr.Radio(choices=["png", "jpeg"], label="आउटपुट प्रारूप चुनें", value="png", interactive=True),
        gr.Button(value="उत्पादन रोकें", interactive=True, variant="stop"),
    ],
    outputs=[
        gr.Image(type="filepath", label="उत्पन्न छवि"),
        gr.Textbox(label="संदेश", type="text"),
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको कोई भी टेक्स्ट दर्ज करने और Stable Diffusion 3 का उपयोग करके छवियां उत्पन्न करने की अनुमति देता है। "
                "आप स्लाइडर्स से उत्पादन सेटिंग्स को अनुकूलित कर सकते हैं। "
                "इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
sd3_img2img_interface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Textbox(label="अपना नकारात्मक प्रॉम्प्ट दर्ज करें", value=""),
        gr.Image(label="प्रारंभिक छवि", type="filepath"),
        gr.Slider(minimum=0.0, maximum=1.0, value=0.8, step=0.01, label="शक्ति"),
        gr.Slider(minimum=1, maximum=100, value=40, step=1, label="चरण"),
        gr.Slider(minimum=1.0, maximum=30.0, value=8.0, step=0.1, label="CFG"),
        gr.Slider(minimum=256, maximum=2048, value=1024, step=64, label="चौड़ाई"),
        gr.Slider(minimum=256, maximum=2048, value=1024, step=64, label="ऊंचाई"),
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको कोई भी टेक्स्ट और प्रारंभिक छवि दर्ज करने और Stable Diffusion 3 का उपयोग करके नई छवियां उत्पन्न करने की अनुमति देता है। "
                "आप स्लाइडर्स से उत्पादन सेटिंग्स को अनुकूलित कर सकते हैं। "
                "इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
sd3_controlnet_interface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Textbox(label="अपना नकारात्मक प्रॉम्प्ट दर्ज करें", value=""),
        gr.Image(label="प्रारंभिक छवि", type="filepath"),
        gr.Dropdown(choices=["Pose", "Canny"], label="ControlNet मॉडल चुनें", value="Pose"),
        gr.Slider(minimum=1, maximum=100, value=40, step=1, label="चरण"),
        gr.Slider(minimum=1.0, maximum=30.0, value=8.0, step=0.1, label="CFG"),
        gr.Slider(minimum=0.1, maximum=1.0, value=0.5, step=0.1, label="ControlNet कंडीशनिंग स्केल"),
        gr.Slider(minimum=256, maximum=2048, value=1024, step=64, label="चौड़ाई"),
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको Stable Diffusion 3 के साथ ControlNet मॉडल का उपयोग करने की अनुमति देता है। "
                "आप स्लाइडर्स से उत्पादन सेटिंग्स को अनुकूलित कर सकते हैं। "
                "इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
sd3_inpaint_interface = gr.Interface(
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको Stable Diffusion 3 का उपयोग करके इनपेंटिंग करने की अनुमति देता है। "
                "आप स्लाइडर्स से उत्पादन सेटिंग्स को अनुकूलित कर सकते हैं। "
                "इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
cascade_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="अपना प्रॉम्प्ट दर्ज करें"),
        gr.Textbox(label="अपना नकारात्मक प्रॉम्प्ट दर्ज करें", value=""),
        gr.HTML("<h3>Stable Cascade सेटिंग्स</h3>"),
        gr.Slider(minimum=256, maximum=4096, value=1024, step=64, label="चौड़ाई"),
        gr.Slider(minimum=256, maximum=4096, value=1024, step=64, label="ऊंचाई"),
        gr.Slider(minimum=1, maximum=100, value=30, step=1, label="पूर्व कदम"),
        gr.Slider(minimum=1.0, maximum=30.0, value=4.0, step=0.1, label="पूर्व मार्गदर्शन स्केल"),
        gr.Slider(minimum=1, maximum=100, value=20, step=1, label="डिकोडर कदम"),
        gr.Slider(minimum=0.0, maximum=30.0, value=8.0, step=0.1, label="डिकोडर मार्गदर्शन स्केल"),
        gr.Radio(choices=["png", "jpeg"], label="आउटपुट प्रारूप चुनें", value="png", interactive=True),
        gr.Button(value="जनरेशन रोकें", interactive=True, variant="stop"),
    ],
    outputs=[
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको एक प्रॉम्प्ट दर्ज करने और Stable Cascade का उपयोग करके छवियाँ उत्पन्न करने की अनुमति देता है। आप स्लाइडर्स से जनरेशन सेटिंग्स को अनुकूलित कर सकते हैं। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
extras_interface = gr.Interface(
    ...
    inputs=[
        gr.Image(label="संशोधित करने के लिए छवि", type="filepath"),
        gr.Image(label="स्रोत छवि", type="filepath"),
        gr.Checkbox(label="पृष्ठभूमि हटाएँ", value=False),
        gr.Checkbox(label="फेस स्वैप सक्षम करें", value=False),
        gr.Checkbox(label="फेस रिस्टोर सक्षम करें", value=False),
        gr.Radio(choices=["png", "jpeg"], label="आउटपुट प्रारूप चुनें", value="png", interactive=True),
        gr.Button(value="जनरेशन रोकें", interactive=True, variant="stop"),
    ],
    outputs=[
        gr.Image(label="संशोधित छवि", type="filepath"),
        gr.Textbox(label="संदेश", type="text"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - StableDiffusion (extras)",
    description="यह उपयोगकर्ता इंटरफ़ेस आपको छवि को संशोधित करने की अनुमति देता है",
    allow_flagging="never",
)
...
kandinsky_txt2img_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="अपना प्रॉम्प्ट दर्ज करें"),
        gr.Textbox(label="अपना नकारात्मक प्रॉम्प्ट दर्ज करें", value=""),
        gr.Radio(choices=["2.1", "2.2", "3"], label="Kandinsky संस्करण", value="2.2"),
        gr.Slider(minimum=1, maximum=100, value=50, step=1, label="चरण"),
        gr.Slider(minimum=0.1, maximum=20, value=4, step=0.1, label="CFG"),
        gr.Slider(minimum=256, maximum=2048, value=768, step=64, label="ऊंचाई"),
        gr.Slider(minimum=256, maximum=2048, value=768, step=64, label="चौड़ाई"),
        gr.Radio(choices=["png", "jpeg"], label="आउटपुट प्रारूप चुनें", value="png", interactive=True),
        gr.Button(value="जनरेशन रोकें", interactive=True, variant="stop"),
    ],
    outputs=[
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको Kandinsky मॉडल का उपयोग करके छवियां उत्पन्न करने की अनुमति देता है। "
                "आप संस्करण 2.1, 2.2 और 3 के बीच चुन सकते हैं, और जनरेशन सेटिंग्स को अनुकूलित कर सकते हैं। "
                "इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
kandinsky_inpaint_interface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Image(label="प्रारंभिक छवि", type="filepath"),
        gr.ImageEditor(label="मास्क छवि", type="filepath"),
        gr.Radio(choices=["2.1", "2.2"], label="Kandinsky संस्करण", value="2.2"),
        gr.Slider(minimum=1, maximum=100, value=50, step=1, label="चरण"),
        gr.Slider(minimum=0.1, maximum=20, value=4, step=0.1, label="CFG"),
        gr.Slider(minimum=0.0, maximum=1.0, value=0.8, step=0.01, label="शक्ति"),
        gr.Slider(minimum=256, maximum=2048, value=768, step=64, label="ऊंचाई"),
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको Kandinsky मॉडल का उपयोग करके इनपेंटिंग करने की अनुमति देता है। "
                "आप संस्करण 2.1 और 2.2 के बीच चुन सकते हैं, और जनरेशन सेटिंग्स को अनुकूलित कर सकते हैं। "
                "इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
flux_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="अपना प्रॉम्प्ट दर्ज करें"),
        gr.Dropdown(choices=["FLUX.1-schnell", "FLUX.1-dev"], label="Flux मॉडल चुनें", value="FLUX.1-schnell"),
        gr.Slider(minimum=0.0, maximum=10.0, value=0.0, step=0.1, label="मार्गदर्शन स्केल"),
        gr.Slider(minimum=256, maximum=2048, value=768, step=64, label="ऊंचाई"),
        gr.Slider(minimum=256, maximum=2048, value=1024, step=64, label="चौड़ाई"),
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको Flux मॉडल का उपयोग करके छवियाँ उत्पन्न करने की अनुमति देता है। आप Schnell और Dev मॉडल के बीच चुन सकते हैं, और जनरेशन सेटिंग्स को अनुकूलित कर सकते हैं। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
hunyuandit_interface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Textbox(label="अपना नकारात्मक प्रॉम्प्ट दर्ज करें", value=""),
        gr.Slider(minimum=1, maximum=100, value=50, step=1, label="कदम"),
        gr.Slider(minimum=0.1, maximum=30.0, value=7.5, step=0.1, label="मार्गदर्शन स्केल"),
        gr.Slider(minimum=256, maximum=2048, value=768, step=64, label="ऊंचाई"),
        gr.Slider(minimum=256, maximum=2048, value=768, step=64, label="चौड़ाई"),
        gr.Radio(choices=["png", "jpeg"], label="आउटपुट प्रारूप चुनें", value="png", interactive=True),
        gr.Button(value="जनरेशन रोकें", interactive=True, variant="stop"),
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको HunyuanDiT मॉडल का उपयोग करके छवियाँ उत्पन्न करने की अनुमति देता है। एक प्रॉम्प्ट दर्ज करें (अंग्रेजी या चीनी में) और जनरेशन सेटिंग्स को अनुकूलित करें। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
lumina_interface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Textbox(label="अपना नकारात्मक प्रॉम्प्ट दर्ज करें", value=""),
        gr.Slider(minimum=1, maximum=100, value=30, step=1, label="कदम"),
        gr.Slider(minimum=0.1, maximum=30.0, value=4, step=0.1, label="मार्गदर्शन स्केल"),
        gr.Slider(minimum=256, maximum=2048, value=768, step=64, label="ऊंचाई"),
        gr.Slider(minimum=256, maximum=2048, value=768, step=64, label="चौड़ाई"),
        gr.Slider(minimum=1, maximum=1024, value=256, step=1, label="अधिकतम अनुक्रम लंबाई"),
        gr.Radio(choices=["png", "jpeg"], label="आउटपुट प्रारूप चुनें", value="png", interactive=True),
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको Lumina-T2X मॉडल का उपयोग करके छवियाँ उत्पन्न करने की अनुमति देता है। एक प्रॉम्प्ट दर्ज करें और जनरेशन सेटिंग्स को अनुकूलित करें। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
kolors_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="अपना प्रॉम्प्ट दर्ज करें"),
        gr.Textbox(label="अपना नकारात्मक प्रॉम्प्ट दर्ज करें", value=""),
        gr.Slider(minimum=1.0, maximum=20.0, value=6.5, step=0.1, label="मार्गदर्शन स्केल"),
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको Kolors मॉडल का उपयोग करके छवियाँ उत्पन्न करने की अनुमति देता है। एक प्रॉम्प्ट दर्ज करें और जनरेशन सेटिंग्स को अनुकूलित करें। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
wurstchen_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="अपना प्रॉम्प्ट दर्ज करें"),
        gr.Textbox(label="अपना नकारात्मक प्रॉम्प्ट दर्ज करें", value=""),
        gr.Slider(minimum=256, maximum=2048, value=1536, step=64, label="चौड़ाई"),
        gr.Slider(minimum=256, maximum=2048, value=1024, step=64, label="ऊंचाई"),
        gr.Slider(minimum=1, maximum=100, value=50, step=1, label="पूर्व कदम"),
        gr.Slider(minimum=0.1, maximum=30.0, value=4.0, step=0.1, label="पूर्व मार्गदर्शन स्केल"),
        gr.Slider(minimum=1, maximum=100, value=20, step=1, label="डिकोडर कदम"),
        gr.Slider(minimum=0.0, maximum=30.0, value=0.0, step=0.1, label="डिकोडर मार्गदर्शन स्केल"),
        gr.Radio(choices=["png", "jpeg"], label="आउटपुट प्रारूप चुनें", value="png", interactive=True),
        gr.Button(value="जनरेशन रोकें", interactive=True, variant="stop"),
    ],
    outputs=[
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको Würstchen मॉडल का उपयोग करके छवियाँ उत्पन्न करने की अनुमति देता है। एक प्रॉम्प्ट दर्ज करें और जनरेशन सेटिंग्स को अनुकूलित करें। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
deepfloyd_if_txt2img_interface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Textbox(label="अपना नकारात्मक प्रॉम्प्ट दर्ज करें", value=""),
        gr.Slider(minimum=1, maximum=100, value=50, step=1, label="चरण"),
        gr.Slider(minimum=0.1, maximum=30.0, value=6, step=0.1, label="मार्गदर्शन स्केल"),
        gr.Slider(minimum=256, maximum=2048, value=512, step=64, label="चौड़ाई"),
        gr.Slider(minimum=256, maximum=2048, value=512, step=64, label="ऊंचाई"),
        gr.Radio(choices=["png", "jpeg"], label="आउटपुट प्रारूप चुनें", value="png", interactive=True),
        gr.Button(value="जनरेशन रोकें", interactive=True, variant="stop"),
    ...
    outputs=[
        gr.Image(type="filepath", label="उत्पन्न छवि (चरण I)"),
        gr.Image(type="filepath", label="उत्पन्न छवि (चरण II)"),
        gr.Image(type="filepath", label="उत्पन्न छवि (चरण III)"),
        gr.Textbox(label="संदेश", type="text"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - DeepFloyd IF (txt2img)",
    description="यह उपयोगकर्ता इंटरफ़ेस आपको DeepFloyd IF मॉडल का उपयोग करके छवियां उत्पन्न करने की अनुमति देता है। "
                "एक प्रॉम्प्ट दर्ज करें और जनरेशन सेटिंग्स को अनुकूलित करें। "
                "प्रक्रिया में तीन जनरेशन चरण शामिल हैं, जिनमें से प्रत्येक बढ़ती गुणवत्ता वाली छवि उत्पन्न करता है। "
                "इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
deepfloyd_if_img2img_interface = gr.Interface(
    ...
    description="यह इंटरफ़ेस आपको DeepFloyd IF के छवि-से-छवि पाइपलाइन का उपयोग करके छवियां उत्पन्न करने की अनुमति देता है। "
                "एक प्रॉम्प्ट दर्ज करें, एक प्रारंभिक छवि अपलोड करें और जनरेशन सेटिंग्स को अनुकूलित करें। "
                "प्रक्रिया में तीन जनरेशन चरण शामिल हैं, जिनमें से प्रत्येक बढ़ती गुणवत्ता वाली छवि उत्पन्न करता है। "
                "इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
deepfloyd_if_inpaint_interface = gr.Interface(
    ...
    description="यह इंटरफ़ेस आपको DeepFloyd IF का उपयोग करके इनपेंटिंग करने की अनुमति देता है। "
                "एक प्रॉम्प्ट दर्ज करें, एक प्रारंभिक छवि और एक मास्क छवि अपलोड करें, और जनरेशन सेटिंग्स को अनुकूलित करें। "
                "प्रक्रिया में तीन जनरेशन चरण शामिल हैं, जिनमें से प्रत्येक बढ़ती गुणवत्ता वाली छवि उत्पन्न करता है। "
                "इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
pixart_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="अपना प्रॉम्प्ट दर्ज करें"),
        gr.Textbox(label="अपना नकारात्मक प्रॉम्प्ट दर्ज करें", value=""),
        gr.Radio(choices=["Alpha-512", "Alpha-1024", "Sigma-512", "Sigma-1024"], label="PixArt संस्करण", value="Alpha-512"),
        gr.Slider(minimum=1, maximum=100, value=30, step=1, label="कदम"),
        gr.Slider(minimum=0.1, maximum=30.0, value=7.5, step=0.1, label="मार्गदर्शन स्केल"),
        gr.Slider(minimum=256, maximum=2048, value=512, step=64, label="ऊंचाई"),
        gr.Slider(minimum=256, maximum=2048, value=512, step=64, label="चौड़ाई"),
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको PixArt मॉडल का उपयोग करके छवियाँ उत्पन्न करने की अनुमति देता है। आप Alpha और Sigma संस्करणों के बीच चुन सकते हैं, और जनरेशन सेटिंग्स को अनुकूलित कर सकते हैं। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
modelscope_interface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Slider(minimum=1, maximum=100, value=50, step=1, label="कदम"),
        gr.Slider(minimum=1.0, maximum=20.0, value=7.5, step=0.1, label="मार्गदर्शन स्केल"),
        gr.Slider(minimum=256, maximum=1024, value=320, step=64, label="ऊंचाई"),
        gr.Slider(minimum=256, maximum=1024, value=576, step=64, label="चौड़ाई"),
        gr.Slider(minimum=16, maximum=128, value=64, step=1, label="फ्रेम की संख्या"),
        gr.Radio(choices=["mp4", "gif"], label="आउटपुट प्रारूप चुनें", value="mp4", interactive=True),
        gr.Button(value="जनरेशन रोकें", interactive=True, variant="stop"),
    ],
    outputs=[
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको ModelScope का उपयोग करके वीडियो उत्पन्न करने की अनुमति देता है। एक प्रॉम्प्ट दर्ज करें और जनरेशन सेटिंग्स को अनुकूलित करें। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
zeroscope2_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="अपना प्रॉम्प्ट दर्ज करें"),
        gr.Video(label="बेहतर बनाने के लिए वीडियो (वैकल्पिक)", interactive=True),
        gr.Slider(minimum=0.1, maximum=1.0, value=0.5, step=0.1, label="शक्ति"),
        gr.Slider(minimum=1, maximum=100, value=40, step=1, label="कदम"),
        gr.Slider(minimum=256, maximum=1280, value=576, step=64, label="चौड़ाई"),
        gr.Slider(minimum=256, maximum=1280, value=320, step=64, label="ऊंचाई"),
        gr.Slider(minimum=1, maximum=100, value=36, step=1, label="फ्रेम"),
        gr.Checkbox(label="वीडियो बेहतरीकरण सक्षम करें", value=False),
        gr.Button(value="जनरेशन रोकें", interactive=True, variant="stop"),
    ],
    outputs=[
        gr.Video(label="उत्पन्न वीडियो"),
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको ZeroScope 2 मॉडल का उपयोग करके वीडियो उत्पन्न और बेहतर बनाने की अनुमति देता है। आप एक टेक्स्ट प्रॉम्प्ट दर्ज कर सकते हैं, बेहतरीकरण के लिए एक वैकल्पिक वीडियो अपलोड कर सकते हैं, और जनरेशन सेटिंग्स को अनुकूलित कर सकते हैं। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
cogvideox_interface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Textbox(label="अपना नकारात्मक प्रॉम्प्ट दर्ज करें", value=""),
        gr.Slider(minimum=1, maximum=100, value=50, step=1, label="कदम"),
        gr.Slider(minimum=1.0, maximum=20.0, value=6.0, step=0.1, label="मार्गदर्शन स्केल"),
        gr.Slider(minimum=256, maximum=1024, value=512, step=64, label="ऊंचाई"),
        gr.Slider(minimum=256, maximum=1024, value=512, step=64, label="चौड़ाई"),
        gr.Slider(minimum=1, maximum=100, value=16, step=1, label="फ्रेम की संख्या"),
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको CogVideoX का उपयोग करके वीडियो उत्पन्न करने की अनुमति देता है। एक प्रॉम्प्ट दर्ज करें और जनरेशन सेटिंग्स को अनुकूलित करें। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
latte_interface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Slider(minimum=256, maximum=1024, value=512, step=64, label="ऊंचाई"),
        gr.Slider(minimum=256, maximum=1024, value=512, step=64, label="चौड़ाई"),
        gr.Slider(minimum=1, maximum=100, value=16, step=1, label="वीडियो की लंबाई"),
        gr.Button(value="जनरेशन रोकें", interactive=True, variant="stop"),
    ],
    outputs=[
        gr.Image(type="filepath", label="उत्पन्न GIF"),
        gr.Textbox(label="संदेश", type="text"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - Latte",
    description="यह उपयोगकर्ता इंटरफ़ेस आपको Latte का उपयोग करके GIF उत्पन्न करने की अनुमति देता है। एक प्रॉम्प्ट दर्ज करें और जनरेशन सेटिंग्स को अनुकूलित करें। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
triposr_interface = gr.Interface(
    ...
    inputs=[
        gr.Image(label="इनपुट छवि", type="pil"),
        gr.Slider(minimum=32, maximum=320, value=256, step=32, label="मार्चिंग क्यूब्स रेजोल्यूशन"),
        gr.Slider(minimum=0.5, maximum=1.0, value=0.85, step=0.05, label="अग्रभूमि अनुपात"),
        gr.Radio(choices=["obj", "glb"], label="आउटपुट प्रारूप चुनें", value="obj", interactive=True),
        gr.Button(value="जनरेशन रोकें", interactive=True, variant="stop"),
    ],
    outputs=[
        gr.Model3D(label="उत्पन्न 3D वस्तु"),
        gr.Textbox(label="संदेश", type="text"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - TripoSR",
    description="यह उपयोगकर्ता इंटरफ़ेस आपको TripoSR का उपयोग करके 3D वस्तुएँ उत्पन्न करने की अनुमति देता है। एक छवि अपलोड करें और जनरेशन सेटिंग्स को अनुकूलित करें। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
stablefast3d_interface = gr.Interface(
    ...
    inputs=[
        gr.Image(label="इनपुट छवि", type="filepath"),
        gr.Slider(minimum=256, maximum=4096, value=1024, step=256, label="टेक्सचर रेजोल्यूशन"),
        gr.Slider(minimum=0.1, maximum=1.0, value=0.85, step=0.05, label="अग्रभूमि अनुपात"),
        gr.Radio(choices=["none", "triangle", "quad"], label="रीमेश विकल्प", value="none"),
        gr.Radio(choices=["obj", "glb"], label="आउटपुट प्रारूप चुनें", value="obj", interactive=True),
        gr.Button(value="जनरेशन रोकें", interactive=True, variant="stop"),
    ],
    outputs=[
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको StableFast3D का उपयोग करके छवियों से 3D वस्तुएँ उत्पन्न करने की अनुमति देता है। एक छवि अपलोड करें और जनरेशन सेटिंग्स को अनुकूलित करें। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
shap_e_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="अपना प्रॉम्प्ट दर्ज करें"),
        gr.Image(label="प्रारंभिक छवि (वैकल्पिक)", type="filepath", interactive=True),
        gr.Slider(minimum=1, maximum=100, value=50, step=1, label="कदम"),
        gr.Slider(minimum=1.0, maximum=30.0, value=10.0, step=0.1, label="CFG"),
        gr.Slider(minimum=64, maximum=512, value=256, step=64, label="फ्रेम आकार"),
        gr.Button(value="जनरेशन रोकें", interactive=True, variant="stop"),
    ],
    outputs=[
        gr.Model3D(label="उत्पन्न 3D वस्तु"),
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको Shap-E का उपयोग करके 3D वस्तुएँ उत्पन्न करने की अनुमति देता है। आप एक टेक्स्ट प्रॉम्प्ट दर्ज कर सकते हैं या एक प्रारंभिक छवि अपलोड कर सकते हैं, और जनरेशन सेटिंग्स को अनुकूलित कर सकते हैं। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
sv34d_interface = gr.Interface(
    fn=generate_sv34d,
    inputs=[
        gr.File(label="इनपुट फ़ाइल (3D-U और 3D-P के लिए छवि, 4D के लिए MP4 वीडियो)", type="filepath"),
        gr.Radio(choices=["3D-U", "3D-P", "4D"], label="संस्करण", value="3D-U"),
        gr.Slider(minimum=0.0, maximum=90.0, value=10.0, step=0.1, label="उन्नयन डिग्री (केवल 3D-P के लिए)"),
        gr.Button(value="जनरेशन रोकें", interactive=True, variant="stop"),
    ],
    outputs=[
        gr.Video(label="उत्पन्न आउटपुट"),
        gr.Textbox(label="संदेश", type="text"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - SV34D",
    description="यह इंटरफ़ेस आपको SV34D मॉडल का उपयोग करके 3D और 4D सामग्री उत्पन्न करने की अनुमति देता है। 3D-U और 3D-P संस्करणों के लिए एक छवि (PNG, JPG, JPEG) अपलोड करें, या 4D संस्करण के लिए एक MP4 वीडियो अपलोड करें। संस्करण चुनें और आवश्यकतानुसार सेटिंग्स को अनुकूलित करें।",
    allow_flagging="never",
)
...
zero123plus_interface = gr.Interface(
    ...
    inputs=[
        gr.Image(label="इनपुट छवि", type="filepath"),
        gr.Slider(minimum=1, maximum=100, value=75, step=1, label="अनुमान कदम"),
        gr.Radio(choices=["png", "jpeg"], label="आउटपुट प्रारूप चुनें", value="png", interactive=True),
        gr.Button(value="जनरेशन रोकें", interactive=True, variant="stop"),
    ],
    outputs=[
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको Zero123Plus का उपयोग करके 3D-जैसी छवियाँ उत्पन्न करने की अनुमति देता है। एक इनपुट छवि अपलोड करें और अनुमान कदमों की संख्या को अनुकूलित करें। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
stableaudio_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="अपना प्रॉम्प्ट दर्ज करें"),
        gr.Textbox(label="अपना नकारात्मक प्रॉम्प्ट दर्ज करें"),
        gr.Slider(minimum=1, maximum=1000, value=200, step=1, label="कदम"),
        gr.Slider(minimum=0.1, maximum=12, value=4, step=0.1, label="CFG"),
        gr.Slider(minimum=1, maximum=60, value=10, step=1, label="ऑडियो की लंबाई (सेकंड)"),
        gr.Slider(minimum=1, maximum=60, value=0, step=1, label="ऑडियो शुरुआत (सेकंड)"),
        gr.Slider(minimum=1, maximum=10, value=3, step=1, label="तरंगरूपों की संख्या"),
        gr.Radio(choices=["wav", "mp3", "ogg"], label="आउटपुट प्रारूप चुनें", value="wav", interactive=True),
        gr.Button(value="जनरेशन रोकें", interactive=True, variant="stop"),
    ],
    outputs=[
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको किसी भी पाठ को दर्ज करने और StableAudio का उपयोग करके ऑडियो उत्पन्न करने की अनुमति देता है। आप स्लाइडर्स से जनरेशन सेटिंग्स को अनुकूलित कर सकते हैं। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
audiocraft_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="अपना प्रॉम्प्ट दर्ज करें"),
        gr.Audio(type="filepath", label="मेलोडी ऑडियो (वैकल्पिक)", interactive=True),
        gr.Dropdown(choices=audiocraft_models_list, label="AudioCraft मॉडल चुनें", value=None),
        gr.HTML("<h3>AudioCraft सेटिंग्स</h3>"),
        gr.Radio(choices=["musicgen", "audiogen", "magnet"], label="मॉडल प्रकार चुनें", value="musicgen"),
        gr.Slider(minimum=1, maximum=120, value=10, step=1, label="अवधि (सेकंड)"),
        gr.Slider(minimum=1, maximum=1000, value=250, step=1, label="शीर्ष K"),
        gr.Slider(minimum=0.0, maximum=1.0, value=0.0, step=0.1, label="शीर्ष P"),
        gr.Slider(minimum=0.0, maximum=1.9, value=1.0, step=0.1, label="तापमान"),
        gr.Slider(minimum=1.0, maximum=10.0, value=3.0, step=0.1, label="CFG"),
        gr.Checkbox(label="मल्टीबैंड डिफ्यूज़न सक्षम करें", value=False),
        gr.Radio(choices=["wav", "mp3", "ogg"], label="आउटपुट प्रारूप चुनें (केवल मल्टीबैंड डिफ्यूज़न के बिना काम करता है)", value="wav", interactive=True),
        gr.Button(value="जनरेशन रोकें", interactive=True, variant="stop"),
    ],
    outputs=[
        gr.Audio(label="उत्पन्न ऑडियो", type="filepath"),
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको किसी भी पाठ को दर्ज करने और AudioCraft का उपयोग करके ऑडियो उत्पन्न करने की अनुमति देता है। आप मॉडल चुन सकते हैं और स्लाइडर्स से जनरेशन सेटिंग्स को अनुकूलित कर सकते हैं। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
audioldm2_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="अपना प्रॉम्प्ट दर्ज करें"),
        gr.Textbox(label="अपना नकारात्मक प्रॉम्प्ट दर्ज करें", value=""),
        gr.Dropdown(choices=["cvssp/audioldm2", "cvssp/audioldm2-music"], label="AudioLDM 2 मॉडल चुनें", value="cvssp/audioldm2"),
        gr.Slider(minimum=1, maximum=1000, value=200, step=1, label="कदम"),
        gr.Slider(minimum=1, maximum=60, value=10, step=1, label="लंबाई (सेकंड)"),
        gr.Slider(minimum=1, maximum=10, value=3, step=1, label="तरंगरूपों की संख्या"),
        gr.Radio(choices=["wav", "mp3", "ogg"], label="आउटपुट प्रारूप चुनें", value="wav", interactive=True),
        gr.Button(value="जनरेशन रोकें", interactive=True, variant="stop"),
    ],
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको किसी भी पाठ को दर्ज करने और AudioLDM 2 का उपयोग करके ऑडियो उत्पन्न करने की अनुमति देता है। आप मॉडल चुन सकते हैं और स्लाइडर्स से जनरेशन सेटिंग्स को अनुकूलित कर सकते हैं। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
demucs_interface = gr.Interface(
    fn=demucs_separate,
    inputs=[
        gr.Audio(type="filepath", label="अलग करने के लिए ऑडियो फ़ाइल"),
        gr.Radio(choices=["wav", "mp3", "ogg"], label="आउटपुट प्रारूप चुनें", value="wav", interactive=True),
    ],
    outputs=[
        gr.Audio(label="वोकल", type="filepath"),
        gr.Audio(label="इंस्ट्रुमेंटल", type="filepath"),
        gr.Textbox(label="संदेश", type="text"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - Demucs",
    description="यह उपयोगकर्ता इंटरफ़ेस आपको एक ऑडियो फ़ाइल अपलोड करने और Demucs का उपयोग करके इसे वोकल और इंस्ट्रुमेंटल में अलग करने की अनुमति देता है। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
gallery_interface = gr.Interface(
    ...
    inputs=[
        gr.Dropdown(label="टेक्स्ट फ़ाइलें", choices=get_output_files()[0], interactive=True),
        gr.Dropdown(label="छवि फ़ाइलें", choices=get_output_files()[1], interactive=True),
        gr.Dropdown(label="वीडियो फ़ाइलें", choices=get_output_files()[2], interactive=True),
        gr.Dropdown(label="ऑडियो फ़ाइलें", choices=get_output_files()[3], interactive=True),
        gr.Dropdown(label="3D मॉडल फ़ाइलें", choices=get_output_files()[4], interactive=True),
    ],
    outputs=[
        gr.Textbox(label="टेक्स्ट"),
        gr.Image(label="छवि", type="filepath"),
        gr.Video(label="वीडियो"),
        gr.Audio(label="ऑडियो", type="filepath"),
        gr.Model3D(label="3D मॉडल"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - गैलरी",
    description="यह इंटरफ़ेस आपको आउटपुट डायरेक्टरी से फ़ाइलें देखने की अनुमति देता है",
    allow_flagging="never",
)
...
model_downloader_interface = gr.Interface(
    fn=download_model,
    inputs=[
        gr.Dropdown(choices=[None, "StarlingLM(Transformers7B)", "OpenChat(Llama7B.Q4)"], label="LLM मॉडल डाउनलोड करें", value=None),
        gr.Dropdown(choices=[None, "Dreamshaper8(SD1.5)", "RealisticVisionV4.0(SDXL)"], label="StableDiffusion मॉडल डाउनलोड करें", value=None),
    ],
    outputs=[
        gr.Textbox(label="संदेश", type="text"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - मॉडलडाउनलोडर",
    description="यह उपयोगकर्ता इंटरफ़ेस आपको LLM और StableDiffusion मॉडल डाउनलोड करने की अनुमति देता है",
    allow_flagging="never",
)
...
settings_interface = gr.Interface(
    ...
    inputs=[
        gr.Radio(choices=["True", "False"], label="शेयर मोड", value="False")
    ],
    outputs=[
        gr.Textbox(label="संदेश", type="text")
    ],
    title="NeuroSandboxWebUI (ALPHA) - सेटिंग्स",
    description="यह उपयोगकर्ता इंटरफ़ेस आपको एप्लिकेशन की सेटिंग्स बदलने की अनुमति देता है",
    allow_flagging="never",
)
...
system_interface = gr.Interface(
    ...
    inputs=[],
    outputs=[
        gr.Textbox(label="GPU कुल मेमोरी"),
        gr.Textbox(label="GPU उपयोग की गई मेमोरी"),
        gr.Textbox(label="GPU खाली मेमोरी"),
        gr.Textbox(label="GPU तापमान"),
        gr.Textbox(label="CPU तापमान"),
        gr.Textbox(label="RAM कुल"),
        gr.Textbox(label="RAM उपयोग की गई"),
        gr.Textbox(label="RAM खाली"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - सिस्टम",
    description="यह इंटरफ़ेस सिस्टम जानकारी प्रदर्शित करता है",
    allow_flagging="never",
)
...
with gr.TabbedInterface(
    [
        ...
        gr.TabbedInterface(
            ...
            tab_names=["गैलरी", "मॉडलडाउनलोडर", "सेटिंग्स", "सिस्टम"]
        )
    ],
    tab_names=["टेक्स्ट", "छवि", "वीडियो", "3D", "ऑडियो", "इंटरफ़ेस"]
) as app:
