...
kandinsky_interface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Slider(minimum=256, maximum=1024, value=768, step=64, label="ऊंचाई"),
        gr.Slider(minimum=256, maximum=1024, value=768, step=64, label="चौड़ाई"),
        gr.Radio(choices=["png", "jpeg"], label="आउटपुट प्रारूप चुनें", value="png", interactive=True),
        gr.Button(value="जनरेशन रोकें", interactive=True, variant="stop"),
    ],
    outputs=[
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको Kandinsky मॉडल का उपयोग करके छवियाँ उत्पन्न करने की अनुमति देता है। आप 2.1, 2.2, और 3 संस्करणों के बीच चुन सकते हैं, और जनरेशन सेटिंग्स को अनुकूलित कर सकते हैं। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
...
deepfloyd_if_interface = gr.Interface(
    ...
    description="यह उपयोगकर्ता इंटरफ़ेस आपको DeepFloyd IF मॉडल का उपयोग करके छवियाँ उत्पन्न करने की अनुमति देता है। एक प्रॉम्प्ट दर्ज करें और जनरेशन सेटिंग्स को अनुकूलित करें। जनरेशन प्रक्रिया में तीन चरण शामिल हैं, प्रत्येक चरण बढ़ती गुणवत्ता की एक छवि उत्पन्न करता है। इसे आजमाएं और देखें क्या होता है!",
    allow_flagging="never",
)
