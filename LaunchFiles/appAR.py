...
chat_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="أدخل طلبك"),
        gr.Audio(type="filepath", label="سجل طلبك (اختياري)"),
        gr.Image(label="قم بتحميل صورتك (اختياري)", type="filepath"),
        gr.Dropdown(choices=llm_models_list, label="اختر نموذج LLM", value=None),
        gr.Dropdown(choices=llm_lora_models_list, label="اختر نموذج LoRA (اختياري)", value=None),
        gr.HTML("<h3>إعدادات LLM</h3>"),
        gr.Radio(choices=["transformers", "llama"], label="اختر نوع النموذج", value="transformers"),
        gr.Slider(minimum=1, maximum=4096, value=512, step=1, label="الحد الأقصى للطول (لنماذج transformers)"),
        gr.Slider(minimum=1, maximum=4096, value=512, step=1, label="الحد الأقصى للرموز (لنماذج llama)"),
        gr.Slider(minimum=0.0, maximum=2.0, value=0.7, step=0.1, label="درجة الحرارة"),
        ...
        gr.Radio(choices=["txt", "json"], label="اختر تنسيق سجل المحادثة", value="txt", interactive=True),
        gr.Checkbox(label="تمكين البحث على الويب", value=False),
        gr.Checkbox(label="تمكين LibreTranslate", value=False),
        gr.Dropdown(choices=["en", "es", "fr", "de", "it", "pt", "pl", "tr", "ru", "nl", "cs", "ar", "zh", "ja", "hi"], label="اختر اللغة الهدف", value="ru", interactive=True),
        gr.Checkbox(label="تمكين الوسائط المتعددة", value=False),
        gr.Checkbox(label="تمكين TTS", value=False),
        gr.HTML("<h3>إعدادات TTS</h3>"),
        gr.Dropdown(choices=speaker_wavs_list, label="اختر الصوت", interactive=True),
        gr.Dropdown(choices=["en", "ru"], label="اختر اللغة", interactive=True),
        gr.Slider(minimum=0.0, maximum=1.9, value=1.0, step=0.1, label="درجة حرارة TTS", interactive=True),
        ...
        gr.Slider(minimum=0.5, maximum=2.0, value=1.0, step=0.1, label="سرعة TTS", interactive=True),
        gr.Radio(choices=["wav", "mp3", "ogg"], label="اختر تنسيق الإخراج", value="wav", interactive=True),
        gr.Button(value="إيقاف التوليد", interactive=True, variant="stop"),
    ],
    outputs=[
        gr.Chatbot(label="استجابة LLM النصية", value=[]),
        gr.Audio(label="استجابة LLM الصوتية", type="filepath"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - LLM",
    description="تتيح لك واجهة المستخدم هذه إدخال أي نص أو صوت وتلقي استجابة مولدة. يمكنك اختيار نموذج LLM والصورة الرمزية والصوت واللغة لـ TTS من القوائم المنسدلة. يمكنك أيضًا تخصيص إعدادات النموذج باستخدام شرائط التمرير. جربها وانظر ماذا يحدث!",
...
tts_stt_interface = gr.Interface(
    fn=generate_tts_stt,
    inputs=[
        gr.Textbox(label="أدخل النص لـ TTS"),
        gr.Audio(label="سجل الصوت لـ STT", type="filepath"),
        gr.HTML("<h3>إعدادات TTS</h3>"),
        gr.Dropdown(choices=speaker_wavs_list, label="اختر الصوت", interactive=True),
        gr.Dropdown(choices=["en", "es", "fr", "de", "it", "pt", "pl", "tr", "ru", "nl", "cs", "ar", "zh-cn", "ja", "hu", "ko", "hi"], label="اختر اللغة", interactive=True),
        gr.Slider(minimum=0.0, maximum=1.9, value=1.0, step=0.1, label="درجة حرارة TTS", interactive=True),
        gr.Slider(minimum=0.0, maximum=1.0, value=0.9, step=0.1, label="TTS Top P", interactive=True),
        gr.Slider(minimum=0, maximum=100, value=20, step=1, label="TTS Top K", interactive=True),
        gr.Slider(minimum=0.5, maximum=2.0, value=1.0, step=0.1, label="سرعة TTS", interactive=True),
        gr.Radio(choices=["wav", "mp3", "ogg"], label="اختر تنسيق إخراج TTS", value="wav", interactive=True),
        gr.Dropdown(choices=["txt", "json"], label="اختر تنسيق إخراج STT", value="txt", interactive=True),
    ],
    outputs=[
        gr.Audio(label="صوت TTS", type="filepath"),
        gr.Textbox(label="نص STT"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - TTS-STT",
    description="تتيح لك واجهة المستخدم هذه إدخال نص للتحويل من النص إلى الكلام (CoquiTTS) وتسجيل الصوت للتحويل من الكلام إلى النص (OpenAIWhisper). بالنسبة لـ TTS، يمكنك اختيار الصوت واللغة وتخصيص إعدادات التوليد باستخدام شرائط التمرير. بالنسبة لـ STT، ما عليك سوى تسجيل الصوت وسيتم عرض النص المنطوق. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
bark_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="أدخل نص الطلب"),
        gr.Dropdown(choices=[None, "v2/en_speaker_1", "v2/ru_speaker_1", "v2/de_speaker_1", "v2/fr_speaker_1", "v2/es_speaker_1", "v2/hi_speaker_1", "v2/it_speaker_1", "v2/ja_speaker_1", "v2/ko_speaker_1", "v2/pt_speaker_1", "v2/zh_speaker_1", "v2/tr_speaker_1", "v2/pl_speaker_1"], label="اختر الإعداد المسبق للصوت", value=None),
        gr.Slider(minimum=1, maximum=1000, value=100, step=1, label="الحد الأقصى للطول"),
        gr.Slider(minimum=0.1, maximum=2.0, value=0.4, step=0.1, label="درجة الحرارة الدقيقة"),
        gr.Slider(minimum=0.1, maximum=2.0, value=0.8, step=0.1, label="درجة الحرارة الخشنة"),
        gr.Radio(choices=["wav", "mp3", "ogg"], label="اختر تنسيق الإخراج", value="wav", interactive=True),
        gr.Button(value="إيقاف التوليد", interactive=True, variant="stop"),
    ],
    outputs=[
        gr.Audio(label="الصوت المولد", type="filepath"),
        gr.Image(label="مخطط ميل الطيفي", type="filepath"),
        gr.Textbox(label="الرسالة", type="text"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - SunoBark",
    description="تتيح لك واجهة المستخدم هذه إدخال نص وتوليد صوت باستخدام SunoBark. يمكنك اختيار الإعداد المسبق للصوت وتخصيص الحد الأقصى للطول. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
translate_interface = gr.Interface(
    fn=translate_text,
    inputs=[
        gr.Textbox(label="أدخل النص للترجمة"),
        gr.Dropdown(choices=["en", "es", "fr", "de", "it", "pt", "pl", "tr", "ru", "nl", "cs", "ar", "zh", "ja", "hi"], label="اختر اللغة المصدر", value="en"),
        gr.Dropdown(choices=["en", "es", "fr", "de", "it", "pt", "pl", "tr", "ru", "nl", "cs", "ar", "zh", "ja", "hi"], label="اختر اللغة الهدف", value="ru"),
        gr.Checkbox(label="تمكين حفظ سجل الترجمة", value=False),
        gr.Radio(choices=["txt", "json"], label="اختر تنسيق سجل الترجمة", value="txt", interactive=True),
        gr.File(label="قم بتحميل ملف نصي (اختياري)", file_count="single", interactive=True),
    ],
    outputs=[
        gr.Textbox(label="النص المترجم"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - LibreTranslate",
    description="تتيح لك واجهة المستخدم هذه إدخال نص وترجمته باستخدام LibreTranslate. اختر اللغة المصدر واللغة الهدف وانقر على إرسال للحصول على الترجمة. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
wav2lip_interface = gr.Interface(
    fn=generate_wav2lip,
    inputs=[
        gr.Image(label="صورة الإدخال", type="filepath"),
        gr.Audio(label="الصوت المدخل", type="filepath"),
        gr.Slider(minimum=1, maximum=60, value=30, step=1, label="إطارات في الثانية"),
        gr.Textbox(label="الحشو", value="0 10 0 0"),
        gr.Slider(minimum=1, maximum=64, value=16, step=1, label="حجم الدفعة لكشف الوجه"),
        gr.Slider(minimum=1, maximum=512, value=128, step=1, label="حجم دفعة Wav2Lip"),
        gr.Slider(minimum=1, maximum=4, value=1, step=1, label="عامل التغيير في الحجم"),
        gr.Textbox(label="القص", value="0 -1 0 -1"),
    ],
    outputs=[
        gr.Video(label="فيديو مزامنة الشفاه المولد"),
        gr.Textbox(label="الرسالة", type="text"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - Wav2Lip",
    description="تتيح لك واجهة المستخدم هذه إنشاء مقاطع فيديو للرأس المتحدث عن طريق الجمع بين صورة وملف صوتي باستخدام Wav2Lip. قم بتحميل صورة وملف صوتي، ثم انقر على توليد لإنشاء فيديو الرأس المتحدث. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
txt2img_interface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Dropdown(choices=stable_diffusion_models_list, label="اختر نموذج StableDiffusion", value=None),
        gr.Dropdown(choices=vae_models_list, label="اختر نموذج VAE (اختياري)", value=None),
        gr.Dropdown(choices=lora_models_list, label="اختر نماذج LORA (اختياري)", value=None, multiselect=True),
        gr.Dropdown(choices=textual_inversion_models_list, label="اختر نماذج Embedding (اختياري)", value=None, multiselect=True),
        gr.HTML("<h3>إعدادات StableDiffusion</h3>"),
        gr.Radio(choices=["SD", "SD2", "SDXL"], label="اختر نوع النموذج", value="SD"),
        gr.Dropdown(choices=["euler_ancestral", "euler", "lms", "heun", "dpm", "dpm_solver", "dpm_solver++"],
                    label="اختر أخذ العينات", value="euler_ancestral"),
        gr.Slider(minimum=1, maximum=100, value=30, step=1, label="الخطوات"),
        gr.Slider(minimum=1.0, maximum=30.0, value=8, step=0.1, label="CFG"),
        gr.Slider(minimum=256, maximum=2048, value=512, step=64, label="العرض"),
        gr.Slider(minimum=256, maximum=2048, value=512, step=64, label="الارتفاع"),
        gr.Slider(minimum=1, maximum=4, value=1, step=1, label="تخطي المقطع"),
        gr.Checkbox(label="تمكين FreeU", value=False),
        gr.Checkbox(label="تمكين Tiled VAE", value=False),
        gr.Checkbox(label="تمكين تحسين الدقة", value=False),
        gr.Radio(choices=["x2", "x4"], label="حجم تحسين الدقة", value="x2"),
        gr.Slider(minimum=1, maximum=100, value=50, step=1, label="خطوات تحسين الدقة"),
        gr.Slider(minimum=1.0, maximum=30.0, value=6, step=0.1, label="CFG لتحسين الدقة"),
    ...
    description="تتيح لك واجهة المستخدم هذه إدخال أي نص وتوليد صور باستخدام StableDiffusion. يمكنك اختيار النموذج وتخصيص إعدادات التوليد باستخدام شرائط التمرير. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
img2img_interface = gr.Interface(
    ...
    description="تتيح لك واجهة المستخدم هذه إدخال أي نص وصورة لتوليد صور جديدة باستخدام StableDiffusion. يمكنك اختيار النموذج وتخصيص إعدادات التوليد باستخدام شرائط التمرير. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
depth2img_interface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Image(label="الصورة الأولية", type="filepath"),
        gr.HTML("<h3>إعدادات StableDiffusion</h3>"),
        gr.Slider(minimum=0.0, maximum=1.0, value=0.7, step=0.01, label="القوة"),
        gr.Radio(choices=["png", "jpeg"], label="اختر تنسيق الإخراج", value="png", interactive=True),
        gr.Button(value="إيقاف التوليد", interactive=True, variant="stop"),
    ],
    outputs=[
    ...
    description="تتيح لك واجهة المستخدم هذه إدخال إشارة وصورة أولية لتوليد صور تدرك العمق باستخدام StableDiffusion. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
pix2pix_interface = gr.Interface(
    ...
    description="تتيح لك واجهة المستخدم هذه إدخال إشارة وصورة أولية لتوليد صور جديدة باستخدام Pix2Pix. يمكنك تخصيص إعدادات التوليد باستخدام شرائط التمرير. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
controlnet_interface = gr.Interface(
    ...
    outputs=[
        gr.Image(type="filepath", label="الصورة المولدة"),
        gr.Image(type="filepath", label="صورة التحكم في ControlNet"),
        gr.Textbox(label="الرسالة", type="text"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - StableDiffusion (controlnet)",
    description="تتيح لك واجهة المستخدم هذه توليد صور باستخدام نماذج ControlNet. قم بتحميل صورة أولية، وأدخل إشارة، واختر نموذج Stable Diffusion، وقم بتخصيص إعدادات التوليد. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
latent_upscale_interface = gr.Interface(
    ...
    inputs=[
        gr.Image(label="الصورة المراد تحسين دقتها", type="filepath"),
        gr.Slider(minimum=1, maximum=100, value=50, step=1, label="الخطوات"),
        gr.Slider(minimum=1.0, maximum=30.0, value=8, step=0.1, label="CFG"),
        gr.Radio(choices=["png", "jpeg"], label="اختر تنسيق الإخراج", value="png", interactive=True),
        gr.Button(value="إيقاف التوليد", interactive=True, variant="stop"),
    ],
    outputs=[
        gr.Image(type="filepath", label="الصورة محسنة الدقة"),
        gr.Textbox(label="الرسالة", type="text"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - StableDiffusion (upscale-latent)",
    description="تتيح لك واجهة المستخدم هذه تحميل صورة وتحسين دقتها في الفضاء الكامن",
    allow_flagging="never",
)
...
realesrgan_upscale_interface = gr.Interface(
    ...
    inputs=[
        gr.Image(label="الصورة المراد تحسين دقتها", type="filepath"),
        gr.Slider(minimum=0.1, maximum=8, value=4, step=0.1, label="عامل تحسين الدقة"),
        gr.Radio(choices=["png", "jpeg"], label="اختر تنسيق الإخراج", value="png", interactive=True),
        gr.Button(value="إيقاف التوليد", interactive=True, variant="stop"),
    ],
    outputs=[
    ...
    description="تتيح لك واجهة المستخدم هذه تحميل صورة وتحسين دقتها باستخدام Real-ESRGAN",
    allow_flagging="never",
)
...
inpaint_interface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Slider(minimum=0, maximum=100, value=0, step=1, label="عامل تمويه القناع"),
        gr.Dropdown(choices=inpaint_models_list, label="اختر نموذج الترميم", value=None),
        gr.Dropdown(choices=vae_models_list, label="اختر نموذج VAE (اختياري)", value=None),
        gr.HTML("<h3>إعدادات StableDiffusion</h3>"),
        gr.Radio(choices=["SD", "SD2", "SDXL"], label="اختر نوع النموذج", value="SD"),
        gr.Dropdown(choices=["euler_ancestral", "euler", "lms", "heun", "dpm", "dpm_solver", "dpm_solver++"],
    ...
    outputs=[
        gr.Image(type="filepath", label="الصورة المرممة"),
        gr.Textbox(label="الرسالة", type="text"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - StableDiffusion (inpaint)",
    description="تتيح لك واجهة المستخدم هذه إدخال إشارة وصورة أولية وصورة قناع لترميم الصورة باستخدام StableDiffusion. يمكنك اختيار النموذج وتخصيص إعدادات التوليد باستخدام شرائط التمرير. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
gligen_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="أدخل الإشارة الخاصة بك"),
        gr.Textbox(label="أدخل الإشارة السلبية الخاصة بك", value=""),
        gr.Textbox(label="أدخل عبارات GLIGEN", value=""),
        gr.Textbox(label="أدخل صناديق GLIGEN", value=""),
        gr.Dropdown(choices=stable_diffusion_models_list, label="اختر نموذج StableDiffusion", value=None),
        gr.HTML("<h3>إعدادات StableDiffusion</h3>"),
        gr.Radio(choices=["SD", "SD2", "SDXL"], label="اختر نوع النموذج", value="SD"),
        gr.Dropdown(choices=["euler_ancestral", "euler", "lms", "heun", "dpm", "dpm_solver", "dpm_solver++"],
    ...
    description="تتيح لك واجهة المستخدم هذه توليد صور باستخدام Stable Diffusion وإدراج كائنات باستخدام GLIGEN. اختر نموذج Stable Diffusion، وقم بتخصيص إعدادات التوليد، وأدخل إشارة وعبارات GLIGEN وصناديق الحدود. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
animatediff_interface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Slider(minimum=1, maximum=100, value=30, step=1, label="الخطوات"),
        gr.Slider(minimum=1.0, maximum=30.0, value=8, step=0.1, label="مقياس التوجيه"),
        gr.Slider(minimum=256, maximum=1024, value=512, step=64, label="العرض"),
        gr.Slider(minimum=256, maximum=1024, value=512, step=64, label="الارتفاع"),
        gr.Button(value="إيقاف التوليد", interactive=True, variant="stop"),
    ],
    outputs=[
        gr.Image(label="GIF المولد", type="filepath"),
        gr.Textbox(label="الرسالة", type="text"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - StableDiffusion (animatediff)",
    description="تتيح لك واجهة المستخدم هذه إدخال إشارة وتوليد صور GIF متحركة باستخدام AnimateDiff. يمكنك اختيار النموذج وتخصيص إعدادات التوليد باستخدام شرائط التمرير. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
video_interface = gr.Interface(
    ...
    inputs=[
        gr.Image(label="الصورة الأولية", type="filepath"),
        gr.Radio(choices=["mp4", "gif"], label="اختر تنسيق الإخراج", value="mp4", interactive=True),
        gr.HTML("<h3>إعدادات SVD (mp4)</h3>"),
        gr.Slider(minimum=0, maximum=360, value=180, step=1, label="معرف وعاء الحركة"),
        gr.Slider(minimum=0.0, maximum=1.0, value=0.1, step=0.01, label="قوة تعزيز الضوضاء"),
        gr.Slider(minimum=1, maximum=60, value=10, step=1, label="إطارات في الثانية"),
        gr.Slider(minimum=2, maximum=120, value=25, step=1, label="الإطارات"),
        gr.Slider(minimum=1, maximum=32, value=8, step=1, label="حجم كتلة فك التشفير"),
        gr.HTML("<h3>إعدادات I2VGen-xl (gif)</h3>"),
        gr.Textbox(label="الإشارة", value=""),
        gr.Textbox(label="الإشارة السلبية", value=""),
        gr.Slider(minimum=1, maximum=100, value=50, step=1, label="الخطوات"),
        gr.Slider(minimum=1.0, maximum=30.0, value=9.0, step=0.1, label="CFG"),
        gr.Button(value="إيقاف التوليد", interactive=True, variant="stop"),
    ],
    outputs=[
        gr.Video(label="الفيديو المولد"),
        gr.Image(label="GIF المولد", type="filepath"),
        gr.Textbox(label="الرسالة", type="text"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - StableDiffusion (video)",
    description="تتيح لك واجهة المستخدم هذه إدخال صورة أولية وتوليد فيديو باستخدام StableVideoDiffusion (mp4) و I2VGen-xl (gif). يمكنك تخصيص إعدادات التوليد باستخدام شرائط التمرير. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
ldm3d_interface = gr.Interface(
    ...
    outputs=[
        gr.Image(type="filepath", label="الصورة RGB المولدة"),
        gr.Image(type="filepath", label="صورة العمق المولدة"),
        gr.Textbox(label="الرسالة", type="text"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - StableDiffusion (LDM3D)",
    description="تتيح لك واجهة المستخدم هذه إدخال إشارة وتوليد صور RGB وعمق باستخدام LDM3D. يمكنك تخصيص إعدادات التوليد باستخدام شرائط التمرير. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
cascade_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="أدخل الإشارة الخاصة بك"),
        gr.Textbox(label="أدخل الإشارة السلبية الخاصة بك", value=""),
        gr.HTML("<h3>إعدادات Stable Cascade</h3>"),
        gr.Slider(minimum=256, maximum=4096, value=1024, step=64, label="العرض"),
        gr.Slider(minimum=256, maximum=4096, value=1024, step=64, label="الارتفاع"),
        gr.Slider(minimum=1, maximum=100, value=30, step=1, label="خطوات المسبق"),
        gr.Slider(minimum=1.0, maximum=30.0, value=4.0, step=0.1, label="مقياس التوجيه المسبق"),
        gr.Slider(minimum=1, maximum=100, value=20, step=1, label="خطوات فك التشفير"),
        gr.Slider(minimum=0.0, maximum=30.0, value=8.0, step=0.1, label="مقياس توجيه فك التشفير"),
        gr.Radio(choices=["png", "jpeg"], label="اختر تنسيق الإخراج", value="png", interactive=True),
        gr.Button(value="إيقاف التوليد", interactive=True, variant="stop"),
    ],
    outputs=[
    ...
    description="تتيح لك واجهة المستخدم هذه إدخال إشارة وتوليد صور باستخدام Stable Cascade. يمكنك تخصيص إعدادات التوليد باستخدام شرائط التمرير. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
instantid_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="أدخل الإشارة الخاصة بك"),
        gr.Textbox(label="أدخل الإشارة السلبية الخاصة بك", value=""),
        gr.Image(label="صورة الوجه", type="filepath"),
        gr.Dropdown(choices=stable_diffusion_models_list, label="اختر نموذج StableDiffusion XL", value=None),
        gr.Slider(minimum=0.0, maximum=1.0, value=0.8, step=0.01, label="مقياس تكييف ControlNet"),
        gr.Slider(minimum=0.0, maximum=1.0, value=0.8, step=0.01, label="مقياس IP-Adapter"),
        gr.Slider(minimum=1, maximum=150, value=30, step=1, label="الخطوات"),
        gr.Slider(minimum=1.0, maximum=20.0, value=7.5, step=0.1, label="مقياس التوجيه (CFG)"),
        gr.Slider(minimum=256, maximum=2048, value=512, step=64, label="العرض"),
        gr.Slider(minimum=256, maximum=2048, value=768, step=64, label="الارتفاع"),
        gr.Radio(choices=["png", "jpeg"], label="اختر تنسيق الإخراج", value="png", interactive=True),
        gr.Button(value="إيقاف التوليد", interactive=True, variant="stop"),
    ],
    outputs=[
    ...
    description="تتيح لك واجهة المستخدم هذه إنشاء صور باستخدام InstantID. "
                "قم بتحميل صورة وجه، وأدخل إشارة، واختر نموذج Stable Diffusion، وقم بتخصيص إعدادات التوليد. "
                "جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
photomaker_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="أدخل الإشارة الخاصة بك"),
        gr.Textbox(label="أدخل الإشارة السلبية الخاصة بك", value=""),
        gr.File(label="قم بتحميل الصور المدخلة", file_count="multiple", type="filepath"),
        gr.Textbox(label="أدخل الكلمة المحفزة", value="img"),
        gr.Dropdown(choices=stable_diffusion_models_list, label="اختر نموذج StableDiffusion XL", value=None),
        gr.Slider(minimum=1, maximum=150, value=30, step=1, label="الخطوات"),
        gr.Slider(minimum=1.0, maximum=20.0, value=7.5, step=0.1, label="مقياس التوجيه (CFG)"),
        gr.Slider(minimum=256, maximum=2048, value=512, step=64, label="العرض"),
    ...
    description="تتيح لك واجهة المستخدم هذه إنشاء صور باستخدام PhotoMaker. "
                "قم بتحميل الصور المدخلة، وأدخل إشارة، واختر نموذجًا أساسيًا، وقم بتخصيص إعدادات التوليد. "
                "جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
ip_adapter_faceid_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="أدخل الإشارة الخاصة بك"),
        gr.Textbox(label="أدخل الإشارة السلبية الخاصة بك", value=""),
        gr.Image(label="قم بتحميل صورة الوجه", type="filepath"),
        gr.Dropdown(choices=stable_diffusion_models_list, label="اختر نموذج StableDiffusion", value=None),
        gr.Dropdown(
            choices=[
            ...
            label="اختر إصدار IP-Adapter-FaceID",
    ...
    description="تتيح لك واجهة المستخدم هذه إنشاء صور باستخدام IP-Adapter-FaceID. "
                "قم بتحميل صورة وجه، وأدخل إشارة، واختر نموذجًا أساسيًا وإصدار IP-Adapter، وقم بتخصيص إعدادات التوليد. "
                "جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
extras_interface = gr.Interface(
    ...
    inputs=[
        gr.Image(label="الصورة المراد تعديلها", type="filepath"),
        gr.Image(label="الصورة المصدر", type="filepath"),
        gr.Checkbox(label="إزالة الخلفية", value=False),
        gr.Checkbox(label="تمكين تبديل الوجوه", value=False),
        gr.Checkbox(label="تمكين استعادة الوجه", value=False),
        gr.Radio(choices=["png", "jpeg"], label="اختر تنسيق الإخراج", value="png", interactive=True),
        gr.Button(value="إيقاف التوليد", interactive=True, variant="stop"),
    ],
    outputs=[
        gr.Image(label="الصورة المعدلة", type="filepath"),
        gr.Textbox(label="الرسالة", type="text"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - StableDiffusion (extras)",
    description="تتيح لك واجهة المستخدم هذه تعديل الصورة",
    allow_flagging="never",
)
...
kandinsky_txt2img_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="أدخل النص التحفيزي الخاص بك"),
        gr.Textbox(label="أدخل النص التحفيزي السلبي الخاص بك", value=""),
        gr.Radio(choices=["2.1", "2.2", "3"], label="إصدار Kandinsky", value="2.2"),
        gr.Slider(minimum=1, maximum=100, value=50, step=1, label="الخطوات"),
        gr.Slider(minimum=0.1, maximum=20, value=4, step=0.1, label="التكوين"),
        gr.Slider(minimum=256, maximum=2048, value=768, step=64, label="الارتفاع"),
        gr.Slider(minimum=256, maximum=2048, value=768, step=64, label="العرض"),
        gr.Radio(choices=["png", "jpeg"], label="حدد تنسيق الإخراج", value="png", interactive=True),
        gr.Button(value="إيقاف التوليد", interactive=True, variant="stop"),
    ],
    outputs=[
    ...
    description="تتيح واجهة المستخدم هذه إنشاء صور باستخدام نماذج Kandinsky. "
                "يمكنك الاختيار بين الإصدارات 2.1 و 2.2 و 3، وتخصيص إعدادات التوليد. "
                "جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
kandinsky_inpaint_interface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Image(label="الصورة الأولية", type="filepath"),
        gr.ImageEditor(label="صورة القناع", type="filepath"),
        gr.Radio(choices=["2.1", "2.2"], label="إصدار Kandinsky", value="2.2"),
        gr.Slider(minimum=1, maximum=100, value=50, step=1, label="الخطوات"),
        gr.Slider(minimum=0.1, maximum=20, value=4, step=0.1, label="التكوين"),
        gr.Slider(minimum=0.0, maximum=1.0, value=0.8, step=0.01, label="القوة"),
        gr.Slider(minimum=256, maximum=2048, value=768, step=64, label="الارتفاع"),
    ...
    description="تتيح لك واجهة المستخدم هذه إجراء إعادة الرسم باستخدام نماذج Kandinsky. "
                "يمكنك الاختيار بين الإصدارين 2.1 و2.2، وتخصيص إعدادات التوليد. "
                "جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
flux_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="أدخل الإشارة الخاصة بك"),
        gr.Dropdown(choices=["FLUX.1-schnell", "FLUX.1-dev"], label="اختر نموذج Flux", value="FLUX.1-schnell"),
        gr.Slider(minimum=0.0, maximum=10.0, value=0.0, step=0.1, label="مقياس التوجيه"),
        gr.Slider(minimum=256, maximum=2048, value=768, step=64, label="الارتفاع"),
        gr.Slider(minimum=256, maximum=2048, value=1024, step=64, label="العرض"),
        gr.Slider(minimum=1, maximum=100, value=10, step=1, label="الخطوات"),
        gr.Slider(minimum=1, maximum=1024, value=256, step=1, label="الحد الأقصى لطول التسلسل"),
        gr.Radio(choices=["png", "jpeg"], label="اختر تنسيق الإخراج", value="png", interactive=True),
        gr.Button(value="إيقاف التوليد", interactive=True, variant="stop"),
    ],
    outputs=[
    ...
    description="تتيح لك واجهة المستخدم هذه توليد صور باستخدام نماذج Flux. يمكنك الاختيار بين نماذج Schnell وDev، وتخصيص إعدادات التوليد. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
hunyuandit_interface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Textbox(label="أدخل الإشارة السلبية الخاصة بك", value=""),
        gr.Slider(minimum=1, maximum=100, value=50, step=1, label="الخطوات"),
        gr.Slider(minimum=0.1, maximum=30.0, value=7.5, step=0.1, label="مقياس التوجيه"),
        gr.Slider(minimum=256, maximum=2048, value=768, step=64, label="الارتفاع"),
        gr.Slider(minimum=256, maximum=2048, value=768, step=64, label="العرض"),
        gr.Radio(choices=["png", "jpeg"], label="اختر تنسيق الإخراج", value="png", interactive=True),
        gr.Button(value="إيقاف التوليد", interactive=True, variant="stop"),
    ...
    description="تتيح لك واجهة المستخدم هذه توليد صور باستخدام نموذج HunyuanDiT. أدخل إشارة (باللغة الإنجليزية أو الصينية) وقم بتخصيص إعدادات التوليد. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
lumina_interface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Textbox(label="أدخل الإشارة السلبية الخاصة بك", value=""),
        gr.Slider(minimum=1, maximum=100, value=30, step=1, label="الخطوات"),
        gr.Slider(minimum=0.1, maximum=30.0, value=4, step=0.1, label="مقياس التوجيه"),
        gr.Slider(minimum=256, maximum=2048, value=768, step=64, label="الارتفاع"),
        gr.Slider(minimum=256, maximum=2048, value=768, step=64, label="العرض"),
        gr.Slider(minimum=1, maximum=1024, value=256, step=1, label="الحد الأقصى لطول التسلسل"),
        gr.Radio(choices=["png", "jpeg"], label="اختر تنسيق الإخراج", value="png", interactive=True),
    ...
    description="تتيح لك واجهة المستخدم هذه توليد صور باستخدام نموذج Lumina-T2X. أدخل إشارة وقم بتخصيص إعدادات التوليد. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
kolors_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="أدخل الإشارة الخاصة بك"),
        gr.Textbox(label="أدخل الإشارة السلبية الخاصة بك", value=""),
        gr.Slider(minimum=1.0, maximum=20.0, value=6.5, step=0.1, label="مقياس التوجيه"),
        gr.Slider(minimum=1, maximum=100, value=25, step=1, label="الخطوات"),
        gr.Slider(minimum=1, maximum=1024, value=256, step=1, label="الحد الأقصى لطول التسلسل"),
        gr.Radio(choices=["png", "jpeg"], label="اختر تنسيق الإخراج", value="png", interactive=True),
        gr.Button(value="إيقاف التوليد", interactive=True, variant="stop"),
    ],
    ...
    description="تتيح لك واجهة المستخدم هذه توليد صور باستخدام نموذج Kolors. أدخل إشارة وقم بتخصيص إعدادات التوليد. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
auraflow_interface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Textbox(label="أدخل الإشارة السلبية الخاصة بك", value=""),
        gr.Slider(minimum=1, maximum=100, value=25, step=1, label="الخطوات"),
        gr.Slider(minimum=1.0, maximum=20.0, value=7.5, step=0.1, label="مقياس التوجيه"),
        gr.Slider(minimum=256, maximum=2048, value=512, step=64, label="الارتفاع"),
        gr.Slider(minimum=256, maximum=2048, value=512, step=64, label="العرض"),
        gr.Slider(minimum=1, maximum=1024, value=256, step=1, label="الحد الأقصى لطول التسلسل"),
        gr.Checkbox(label="تمكين AuraSR", value=False),
        gr.Radio(choices=["png", "jpeg"], label="اختر تنسيق الإخراج", value="png", interactive=True),
        gr.Button(value="إيقاف التوليد", interactive=True, variant="stop"),
    ],
    outputs=[
    ...
    description="تتيح لك واجهة المستخدم هذه إنشاء صور باستخدام نموذج AuraFlow. "
                "أدخل إشارة وقم بتخصيص إعدادات التوليد. "
                "يمكنك أيضًا تمكين AuraSR لتكبير الصورة المولدة بمقدار 4 أضعاف. "
                "جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
wurstchen_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="أدخل الإشارة الخاصة بك"),
        gr.Textbox(label="أدخل الإشارة السلبية الخاصة بك", value=""),
        gr.Slider(minimum=256, maximum=2048, value=1536, step=64, label="العرض"),
        gr.Slider(minimum=256, maximum=2048, value=1024, step=64, label="الارتفاع"),
        gr.Slider(minimum=1, maximum=100, value=50, step=1, label="خطوات المسبق"),
        gr.Slider(minimum=0.1, maximum=30.0, value=4.0, step=0.1, label="مقياس التوجيه المسبق"),
        gr.Slider(minimum=1, maximum=100, value=20, step=1, label="خطوات فك التشفير"),
        gr.Slider(minimum=0.0, maximum=30.0, value=0.0, step=0.1, label="مقياس توجيه فك التشفير"),
        gr.Radio(choices=["png", "jpeg"], label="اختر تنسيق الإخراج", value="png", interactive=True),
        gr.Button(value="إيقاف التوليد", interactive=True, variant="stop"),
    ],
    outputs=[
    ...
    description="تتيح لك واجهة المستخدم هذه توليد صور باستخدام نموذج Würstchen. أدخل إشارة وقم بتخصيص إعدادات التوليد. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
deepfloyd_if_txt2img_interface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Textbox(label="أدخل النص التحفيزي السلبي الخاص بك", value=""),
        gr.Slider(minimum=1, maximum=100, value=50, step=1, label="الخطوات"),
        gr.Slider(minimum=0.1, maximum=30.0, value=6, step=0.1, label="مقياس التوجيه"),
        gr.Slider(minimum=256, maximum=2048, value=512, step=64, label="العرض"),
        gr.Slider(minimum=256, maximum=2048, value=512, step=64, label="الارتفاع"),
        gr.Radio(choices=["png", "jpeg"], label="حدد تنسيق الإخراج", value="png", interactive=True),
        gr.Button(value="إيقاف التوليد", interactive=True, variant="stop"),
    ...
    outputs=[
        gr.Image(type="filepath", label="الصورة المولدة (المرحلة الأولى)"),
        gr.Image(type="filepath", label="الصورة المولدة (المرحلة الثانية)"),
        gr.Image(type="filepath", label="الصورة المولدة (المرحلة الثالثة)"),
        gr.Textbox(label="الرسالة", type="text"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - DeepFloyd IF (txt2img)",
    description="تتيح لك واجهة المستخدم هذه إنشاء صور باستخدام نموذج DeepFloyd IF. "
                "أدخل نصًا تحفيزيًا وقم بتخصيص إعدادات التوليد. "
                "تتضمن العملية ثلاث مراحل من التوليد، كل منها ينتج صورة ذات جودة متزايدة. "
                "جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
deepfloyd_if_img2img_interface = gr.Interface(
    ...
    description="تتيح لك هذه الواجهة إنشاء صور باستخدام خط أنابيب الصورة إلى الصورة لـ DeepFloyd IF. "
                "أدخل نصًا تحفيزيًا، وقم بتحميل صورة أولية، وتخصيص إعدادات التوليد. "
                "تتضمن العملية ثلاث مراحل من التوليد، كل منها ينتج صورة ذات جودة متزايدة. "
                "جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
deepfloyd_if_inpaint_interface = gr.Interface(
    ...
    description="تتيح لك هذه الواجهة إجراء الرسم الداخلي باستخدام DeepFloyd IF. "
                "أدخل نصًا تحفيزيًا، وقم بتحميل صورة أولية وصورة قناع، وتخصيص إعدادات التوليد. "
                "تتضمن العملية ثلاث مراحل من التوليد، كل منها ينتج صورة ذات جودة متزايدة. "
                "جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
pixart_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="أدخل الإشارة الخاصة بك"),
        gr.Textbox(label="أدخل الإشارة السلبية الخاصة بك", value=""),
        gr.Radio(choices=["Alpha-512", "Alpha-1024", "Sigma-512", "Sigma-1024"], label="إصدار PixArt", value="Alpha-512"),
        gr.Slider(minimum=1, maximum=100, value=30, step=1, label="الخطوات"),
        gr.Slider(minimum=0.1, maximum=30.0, value=7.5, step=0.1, label="مقياس التوجيه"),
        gr.Slider(minimum=256, maximum=2048, value=512, step=64, label="الارتفاع"),
        gr.Slider(minimum=256, maximum=2048, value=512, step=64, label="العرض"),
    ...
    description="تتيح لك واجهة المستخدم هذه توليد صور باستخدام نماذج PixArt. يمكنك الاختيار بين إصدارات Alpha و Sigma، وتخصيص إعدادات التوليد. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
modelscope_interface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Slider(minimum=1, maximum=100, value=50, step=1, label="الخطوات"),
        gr.Slider(minimum=1.0, maximum=20.0, value=7.5, step=0.1, label="مقياس التوجيه"),
        gr.Slider(minimum=256, maximum=1024, value=320, step=64, label="الارتفاع"),
        gr.Slider(minimum=256, maximum=1024, value=576, step=64, label="العرض"),
        gr.Slider(minimum=16, maximum=128, value=64, step=1, label="عدد الإطارات"),
        gr.Radio(choices=["mp4", "gif"], label="اختر تنسيق الإخراج", value="mp4", interactive=True),
        gr.Button(value="إيقاف التوليد", interactive=True, variant="stop"),
    ],
    outputs=[
    ...
    description="تتيح لك واجهة المستخدم هذه توليد مقاطع فيديو باستخدام ModelScope. أدخل إشارة وقم بتخصيص إعدادات التوليد. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
zeroscope2_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="أدخل الإشارة الخاصة بك"),
        gr.Video(label="الفيديو المراد تحسينه (اختياري)", interactive=True),
        gr.Slider(minimum=0.1, maximum=1.0, value=0.5, step=0.1, label="القوة"),
        gr.Slider(minimum=1, maximum=100, value=40, step=1, label="الخطوات"),
        gr.Slider(minimum=256, maximum=1280, value=576, step=64, label="العرض"),
        gr.Slider(minimum=256, maximum=1280, value=320, step=64, label="الارتفاع"),
        gr.Slider(minimum=1, maximum=100, value=36, step=1, label="الإطارات"),
        gr.Checkbox(label="تمكين تحسين الفيديو", value=False),
        gr.Button(value="إيقاف التوليد", interactive=True, variant="stop"),
    ],
    outputs=[
        gr.Video(label="الفيديو المولد"),
    ...
    description="تتيح لك واجهة المستخدم هذه توليد وتحسين مقاطع الفيديو باستخدام نماذج ZeroScope 2. يمكنك إدخال إشارة نصية، وتحميل فيديو اختياري للتحسين، وتخصيص إعدادات التوليد. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
cogvideox_interface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Textbox(label="أدخل الإشارة السلبية الخاصة بك", value=""),
        gr.Slider(minimum=1, maximum=100, value=50, step=1, label="الخطوات"),
        gr.Slider(minimum=1.0, maximum=20.0, value=6.0, step=0.1, label="مقياس التوجيه"),
        gr.Slider(minimum=256, maximum=1024, value=512, step=64, label="الارتفاع"),
        gr.Slider(minimum=256, maximum=1024, value=512, step=64, label="العرض"),
        gr.Slider(minimum=1, maximum=100, value=16, step=1, label="عدد الإطارات"),
        gr.Slider(minimum=1, maximum=60, value=8, step=1, label="إطارات في الثانية"),
        gr.Button(value="إيقاف التوليد", interactive=True, variant="stop"),
    ],
    outputs=[
        gr.Video(label="الفيديو المولد"),
    ...
    description="تتيح لك واجهة المستخدم هذه توليد مقاطع فيديو باستخدام CogVideoX. أدخل إشارة وقم بتخصيص إعدادات التوليد. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
latte_interface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Slider(minimum=256, maximum=1024, value=512, step=64, label="الارتفاع"),
        gr.Slider(minimum=256, maximum=1024, value=512, step=64, label="العرض"),
        gr.Slider(minimum=1, maximum=100, value=16, step=1, label="طول الفيديو"),
        gr.Button(value="إيقاف التوليد", interactive=True, variant="stop"),
    ],
    outputs=[
        gr.Image(type="filepath", label="GIF المولد"),
        gr.Textbox(label="الرسالة", type="text"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - Latte",
    description="تتيح لك واجهة المستخدم هذه توليد صور GIF متحركة باستخدام Latte. أدخل إشارة وقم بتخصيص إعدادات التوليد. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
triposr_interface = gr.Interface(
    ...
    inputs=[
        gr.Image(label="الصورة المدخلة", type="pil"),
        gr.Slider(minimum=32, maximum=320, value=256, step=32, label="دقة المكعبات المتحركة"),
        gr.Slider(minimum=0.5, maximum=1.0, value=0.85, step=0.05, label="نسبة المقدمة"),
        gr.Radio(choices=["obj", "glb"], label="اختر تنسيق الإخراج", value="obj", interactive=True),
        gr.Button(value="إيقاف التوليد", interactive=True, variant="stop"),
    ],
    outputs=[
        gr.Model3D(label="الكائن ثلاثي الأبعاد المولد"),
        gr.Textbox(label="الرسالة", type="text"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - TripoSR",
    description="تتيح لك واجهة المستخدم هذه توليد كائنات ثلاثية الأبعاد باستخدام TripoSR. قم بتحميل صورة وتخصيص إعدادات التوليد. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
stablefast3d_interface = gr.Interface(
    ...
    inputs=[
        gr.Image(label="الصورة المدخلة", type="filepath"),
        gr.Slider(minimum=256, maximum=4096, value=1024, step=256, label="دقة النسيج"),
        gr.Slider(minimum=0.1, maximum=1.0, value=0.85, step=0.05, label="نسبة المقدمة"),
        gr.Radio(choices=["none", "triangle", "quad"], label="خيار إعادة تشكيل الشبكة", value="none"),
        gr.Radio(choices=["obj", "glb"], label="اختر تنسيق الإخراج", value="obj", interactive=True),
        gr.Button(value="إيقاف التوليد", interactive=True, variant="stop"),
    ],
    outputs=[
    ...
    description="تتيح لك واجهة المستخدم هذه توليد كائنات ثلاثية الأبعاد من الصور باستخدام StableFast3D. قم بتحميل صورة وتخصيص إعدادات التوليد. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
shap_e_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="أدخل الإشارة الخاصة بك"),
        gr.Image(label="الصورة الأولية (اختياري)", type="filepath", interactive=True),
        gr.Slider(minimum=1, maximum=100, value=50, step=1, label="الخطوات"),
        gr.Slider(minimum=1.0, maximum=30.0, value=10.0, step=0.1, label="CFG"),
        gr.Slider(minimum=64, maximum=512, value=256, step=64, label="حجم الإطار"),
        gr.Button(value="إيقاف التوليد", interactive=True, variant="stop"),
    ],
    outputs=[
        gr.Model3D(label="الكائن ثلاثي الأبعاد المولد"),
    ...
    description="تتيح لك واجهة المستخدم هذه توليد كائنات ثلاثية الأبعاد باستخدام Shap-E. يمكنك إدخال إشارة نصية أو تحميل صورة أولية، وتخصيص إعدادات التوليد. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
sv34d_interface = gr.Interface(
    fn=generate_sv34d,
    inputs=[
        gr.File(label="الملف المدخل (صورة لـ 3D-U و 3D-P، فيديو MP4 لـ 4D)", type="filepath"),
        gr.Radio(choices=["3D-U", "3D-P", "4D"], label="الإصدار", value="3D-U"),
        gr.Slider(minimum=0.0, maximum=90.0, value=10.0, step=0.1, label="درجة الارتفاع (لـ 3D-P فقط)"),
        gr.Button(value="إيقاف التوليد", interactive=True, variant="stop"),
    ],
    outputs=[
        gr.Video(label="الإخراج المولد"),
        gr.Textbox(label="الرسالة", type="text"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - SV34D",
    description="تتيح لك هذه الواجهة توليد محتوى ثلاثي وأربعي الأبعاد باستخدام نماذج SV34D. قم بتحميل صورة (PNG، JPG، JPEG) لإصدارات 3D-U و 3D-P، أو فيديو MP4 لإصدار 4D. اختر الإصدار وقم بتخصيص الإعدادات حسب الحاجة.",
    allow_flagging="never",
)
...
zero123plus_interface = gr.Interface(
    ...
    inputs=[
        gr.Image(label="الصورة المدخلة", type="filepath"),
        gr.Slider(minimum=1, maximum=100, value=75, step=1, label="خطوات الاستدلال"),
        gr.Radio(choices=["png", "jpeg"], label="اختر تنسيق الإخراج", value="png", interactive=True),
        gr.Button(value="إيقاف التوليد", interactive=True, variant="stop"),
    ],
    outputs=[
    ...
    description="تتيح لك واجهة المستخدم هذه توليد صور شبيهة بالثلاثية الأبعاد باستخدام Zero123Plus. قم بتحميل صورة مدخلة وتخصيص عدد خطوات الاستدلال. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
stableaudio_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="أدخل الإشارة الخاصة بك"),
        gr.Textbox(label="أدخل الإشارة السلبية الخاصة بك"),
        gr.Slider(minimum=1, maximum=1000, value=200, step=1, label="الخطوات"),
        gr.Slider(minimum=0.1, maximum=12, value=4, step=0.1, label="CFG"),
        gr.Slider(minimum=1, maximum=60, value=10, step=1, label="طول الصوت (بالثواني)"),
        gr.Slider(minimum=1, maximum=60, value=0, step=1, label="بداية الصوت (بالثواني)"),
        gr.Slider(minimum=1, maximum=10, value=3, step=1, label="عدد الموجات"),
        gr.Radio(choices=["wav", "mp3", "ogg"], label="اختر تنسيق الإخراج", value="wav", interactive=True),
        gr.Button(value="إيقاف التوليد", interactive=True, variant="stop"),
    ],
    outputs=[
    ...
    description="تتيح لك واجهة المستخدم هذه إدخال أي نص وتوليد صوت باستخدام StableAudio. يمكنك تخصيص إعدادات التوليد باستخدام شرائط التمرير. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
audiocraft_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="أدخل الإشارة الخاصة بك"),
        gr.Audio(type="filepath", label="صوت اللحن (اختياري)", interactive=True),
        gr.Dropdown(choices=audiocraft_models_list, label="اختر نموذج AudioCraft", value=None),
        gr.HTML("<h3>إعدادات AudioCraft</h3>"),
        gr.Radio(choices=["musicgen", "audiogen", "magnet"], label="اختر نوع النموذج", value="musicgen"),
        gr.Slider(minimum=1, maximum=120, value=10, step=1, label="المدة (بالثواني)"),
        ...
        gr.Slider(minimum=0.0, maximum=1.9, value=1.0, step=0.1, label="درجة الحرارة"),
        gr.Slider(minimum=1.0, maximum=10.0, value=3.0, step=0.1, label="CFG"),
        gr.Checkbox(label="تمكين الانتشار متعدد النطاقات", value=False),
        gr.Radio(choices=["wav", "mp3", "ogg"], label="اختر تنسيق الإخراج (يعمل فقط بدون الانتشار متعدد النطاقات)", value="wav", interactive=True),
        gr.Button(value="إيقاف التوليد", interactive=True, variant="stop"),
    ],
    outputs=[
        gr.Audio(label="الصوت المولد", type="filepath"),
    ...
    description="تتيح لك واجهة المستخدم هذه إدخال أي نص وتوليد صوت باستخدام AudioCraft. يمكنك اختيار النموذج وتخصيص إعدادات التوليد باستخدام شرائط التمرير. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
audioldm2_interface = gr.Interface(
    ...
    inputs=[
        gr.Textbox(label="أدخل الإشارة الخاصة بك"),
        gr.Textbox(label="أدخل الإشارة السلبية الخاصة بك", value=""),
        gr.Dropdown(choices=["cvssp/audioldm2", "cvssp/audioldm2-music"], label="اختر نموذج AudioLDM 2", value="cvssp/audioldm2"),
        gr.Slider(minimum=1, maximum=1000, value=200, step=1, label="الخطوات"),
        gr.Slider(minimum=1, maximum=60, value=10, step=1, label="الطول (بالثواني)"),
        gr.Slider(minimum=1, maximum=10, value=3, step=1, label="عدد الموجات"),
        gr.Radio(choices=["wav", "mp3", "ogg"], label="اختر تنسيق الإخراج", value="wav", interactive=True),
        gr.Button(value="إيقاف التوليد", interactive=True, variant="stop"),
    ],
    ...
    description="تتيح لك واجهة المستخدم هذه إدخال أي نص وتوليد صوت باستخدام AudioLDM 2. يمكنك اختيار النموذج وتخصيص إعدادات التوليد باستخدام شرائط التمرير. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
demucs_interface = gr.Interface(
    fn=demucs_separate,
    inputs=[
        gr.Audio(type="filepath", label="ملف الصوت المراد فصله"),
        gr.Radio(choices=["wav", "mp3", "ogg"], label="اختر تنسيق الإخراج", value="wav", interactive=True),
    ],
    outputs=[
        gr.Audio(label="الصوت", type="filepath"),
        gr.Audio(label="الموسيقى", type="filepath"),
        gr.Textbox(label="الرسالة", type="text"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - Demucs",
    description="تتيح لك واجهة المستخدم هذه تحميل ملف صوتي وفصله إلى صوت وموسيقى باستخدام Demucs. جربها وانظر ماذا يحدث!",
    allow_flagging="never",
)
...
gallery_interface = gr.Interface(
    ...
    inputs=[
        gr.Dropdown(label="الملفات النصية", choices=get_output_files()[0], interactive=True),
        gr.Dropdown(label="ملفات الصور", choices=get_output_files()[1], interactive=True),
        gr.Dropdown(label="ملفات الفيديو", choices=get_output_files()[2], interactive=True),
        gr.Dropdown(label="الملفات الصوتية", choices=get_output_files()[3], interactive=True),
        gr.Dropdown(label="ملفات النماذج ثلاثية الأبعاد", choices=get_output_files()[4], interactive=True),
    ],
    outputs=[
        gr.Textbox(label="النص"),
        gr.Image(label="الصورة", type="filepath"),
        gr.Video(label="الفيديو"),
        gr.Audio(label="الصوت", type="filepath"),
        gr.Model3D(label="النموذج ثلاثي الأبعاد"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - المعرض",
    description="تتيح لك هذه الواجهة عرض الملفات من مجلد المخرجات",
    allow_flagging="never",
)
...
model_downloader_interface = gr.Interface(
    fn=download_model,
    inputs=[
        gr.Dropdown(choices=[None, "StarlingLM(Transformers7B)", "OpenChat(Llama7B.Q4)"], label="تنزيل نموذج LLM", value=None),
        gr.Dropdown(choices=[None, "Dreamshaper8(SD1.5)", "RealisticVisionV4.0(SDXL)"], label="تنزيل نموذج StableDiffusion", value=None),
    ],
    outputs=[
        gr.Textbox(label="الرسالة", type="text"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - أداة تنزيل النماذج",
    description="تتيح لك واجهة المستخدم هذه تنزيل نماذج LLM و StableDiffusion",
    allow_flagging="never",
)
...
settings_interface = gr.Interface(
    ...
    inputs=[
        gr.Radio(choices=["True", "False"], label="وضع المشاركة", value="False")
    ],
    outputs=[
        gr.Textbox(label="الرسالة", type="text")
    ],
    title="NeuroSandboxWebUI (ALPHA) - الإعدادات",
    description="تتيح لك واجهة المستخدم هذه تغيير إعدادات التطبيق",
    allow_flagging="never",
)
...
system_interface = gr.Interface(
    ...
    inputs=[],
    outputs=[
        gr.Textbox(label="إجمالي ذاكرة وحدة معالجة الرسومات"),
        gr.Textbox(label="ذاكرة وحدة معالجة الرسومات المستخدمة"),
        gr.Textbox(label="ذاكرة وحدة معالجة الرسومات الحرة"),
        gr.Textbox(label="درجة حرارة وحدة معالجة الرسومات"),
        gr.Textbox(label="درجة حرارة وحدة المعالجة المركزية"),
        gr.Textbox(label="إجمالي ذاكرة الوصول العشوائي"),
        gr.Textbox(label="ذاكرة الوصول العشوائي المستخدمة"),
        gr.Textbox(label="ذاكرة الوصول العشوائي الحرة"),
    ],
    title="NeuroSandboxWebUI (ALPHA) - النظام",
    description="تعرض هذه الواجهة معلومات النظام",
    allow_flagging="never",
)
...
with gr.TabbedInterface(
    [
        ...
        gr.TabbedInterface(
            ...
            tab_names=["المعرض", "أداة تنزيل النماذج", "الإعدادات", "النظام"]
        )
    ],
    tab_names=["النص", "الصورة", "الفيديو", "ثلاثي الأبعاد", "الصوت", "الواجهة"]
) as app:
